...
public class ActionGenerator {
   ...
   * @param connection_id
   */
  public ActionGenerator(String version_number, String transfer_action_id, String collection_id,
      String collection_set_id, String action_type, String transfer_action_name, String order_by_no,
      String where_clause, String action_contents, String enabled_flag, String connection_id) {
    super();
  ...
  /**
   * @param action_contents The aCTION_CONTENTS to set.
   */
  ...
  /**
   * @param order_by_no The oRDER_BY_NO to set.
   */
  public void setORDER_BY_NO(String order_by_no) {
    ORDER_BY_NO = order_by_no;
  }
  /**
  ...
  /**
   * @param transfer_action_id The tRANSFER_ACTION_ID to set.
   */
  public void setTRANSFER_ACTION_ID(String transfer_action_id) {
    TRANSFER_ACTION_ID = transfer_action_id;
  }
  /**
  ...
  /**
   * @param transfer_action_name The tRANSFER_ACTION_NAME to set.
   */
  ...
  /**
   * @param where_clause The wHERE_CLAUSE to set.
   */
  public void setWHERE_CLAUSE(String where_clause) {
    WHERE_CLAUSE = where_clause;
  }
 
  public void insertToDB(RockFactory rockFact) throws Exception{
