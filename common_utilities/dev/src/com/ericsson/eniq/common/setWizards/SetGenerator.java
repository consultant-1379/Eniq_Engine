...
public class SetGenerator {
  ...
  private static Logger log = Logger.getLogger("etlengine.common.SetGenerator");
  ...
  public void insertToDB(RockFactory rockFact) throws Exception{
    ...
    log.finer("Trying to create a set tp "+COLLECTION_SET_ID+" set "+COLLECTION_ID+" ("+COLLECTION_NAME+") ver "+VERSION_NUMBER);
