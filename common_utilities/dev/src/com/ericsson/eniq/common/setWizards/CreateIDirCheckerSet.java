...
public class CreateIDirCheckerSet {
  ...
  public void create(boolean skip) throws Exception {
    ...
    createAction(iAction + 1, "CreateDir", new Long(this.maxSetID + iSet).intValue(),
        new Long(this.maxActionID + iAction).intValue(), "CreateDir_ossDir", "${ARCHIVE_DIR}/${OSS}/",
    ...
    createAction(iAction + 1, "CreateDir", new Long(this.maxSetID + iSet).intValue(),
        ...
        "${ARCHIVE_DIR}/${OSS}/" + name1 + pathSeparator, Utils.propertyToString(prop)).insertToDB(rock);
    iAction++;

    log.info("  Creating action CreateDir_in");
    createAction(iAction + 1, "CreateDir", new Long(this.maxSetID + iSet).intValue(),
        new Long(this.maxActionID + iAction).intValue(), "CreateDir_in", "${PMDATA_DIR}/${OSS}" + pathSeparator,
        Utils.propertyToString(prop)).insertToDB(rock);
    iAction++;
  ...
  private long createCheckers(long iSet, long iAction, String foldername, Properties prop) throws Exception {
    ...
    createAction(iAction + 1, "CreateDir", new Long(this.maxSetID + iSet).intValue(),
        ...
        "${ARCHIVE_DIR}/${OSS}" + pathSeparator + name1 + pathSeparator + foldername + pathSeparator,
        Utils.propertyToString(prop)).insertToDB(rock);
    iAction++;
