...
/**
 * @author ecarbjo Copied and commented version of the EngineLogger class.
...
public class LicensingLogger extends Handler {
	...
	private String subSystemString = "licensemanager";
	...
	public LicensingLogger() throws IOException, SecurityException {	
		...
		String systemDebugFlag = System.getProperty("LicensingLogger.debug");
