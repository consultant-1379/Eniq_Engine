...
public class TPDailyRotationFileHandlerTest {
  ...
  public static void init() {
    ...
    final String[] array = homeDir.split("\\\\");
    String logDir = "";
    for (int i = 0; i < array.length; i++)
      logDir += array[i] + "/";
    
    final File x = new File(homeDir, "properties");
    x.deleteOnExit();
    PrintWriter pw;
  ...
  public void testPublish() {
    ...
    final File logFile = new File(homeDir + File.separator + log + File.separator + "Logger", "file-" + dstamp + ".log");
  ...
  public void testPublish2() {
    ...
    final File logFile = new File(homeDir + File.separator + log + File.separator + "Logger", "engine-" + dstamp + ".log");
  ...
  public void testPublish3() {
    ...
    final File logFile = new File(homeDir + File.separator + log + File.separator + "Logger", "sql-" + dstamp + ".log");
  ...
  public void testPublish4() {
    ...
    final File logFile = new File(homeDir + File.separator + log + File.separator + "Logger", "sqlerror-" + dstamp + ".log");
  ...
  public void testRotate() {
    ...
    final File logFile3 = new File(homeDir, File.separator + log + File.separator + "Logger" + File.separator + "dailyRotation"
        + "-" + "timestamp" + ".log");
  ...
  public static void clean() {
    final File logDir = new File(homeDir + File.separator + log + File.separator + "Logger");
    final File logDir2 = new File(homeDir + File.separator + log);
