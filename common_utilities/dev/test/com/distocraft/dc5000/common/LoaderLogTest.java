...
public class LoaderLogTest {
  ...
  public static void init() {
    ...
    prop.setProperty("SessionHandling.log.LOADER.inputTableDir", homeDir);

    file = new File(homeDir, "loaderLogFile");
    file.deleteOnExit();
  ...
  public void bulkLoadIntoSessionLog(){
	  ...
	  adapter = new File(homeDir, "LOADER." + dateID + ".unfinished");  
	  adapter.deleteOnExit();
	  SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd_HH:mm:ss");
	  try {
		  String expected = "100\tSESSION_ID9999\tBATCH_ID9999\tdateID_value\tTIMELEVEL9999\tDATADATE9999\tDATATIME9999\t9999\t2011-08-05_15:15:40\t2011-08-05_15:15:42\tSOURCE9999\tOK9999\tTYPENAME9999\t0\t";
  ...
  public void bulkLoadIntoSessionLogError(){
	  ...
	  adapter = new File(homeDir, "LOADER..unfinished");  
  ...
  public void bulkLoadIntoSessionLogError2(){
	  ...
	  SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd_HH:mm:ss");
	  try {
		  String expected = "100\tSESSION_ID2\tBATCH_ID2\tdateID_value\tTIMELEVEL2\tDATADATE2\tDATATIME2\t2\t2011-08-05_15:15:40\t2011-08-05_15:15:42\tSOURCE2\tOK\tTYPENAME2\t0\t";
		  String actual = new HelpClass().readFileToString(adapter);
  ...
  public void testLoaderLog() {
    ...
    final File adapter = new File(homeDir, "LOADER." + dateID + ".unfinished");  
    adapter.deleteOnExit();
  ...
  public void rotateTest() {
  	...
  	// Rotate should rename file1->rfile1 & file2->rfile2
		...
		final File file1 = new File(homeDir, "LOADER.1.unfinished");
		final File rfile1 = new File(homeDir, "LOADER.1");
		final File file2 = new File(homeDir, "LOADER.2");
		final File file3 = new File(homeDir, "LOADER.3.unfinished");
		final File rfile3 = new File(homeDir, "LOADER.3");
  ...
  public static junit.framework.Test suite() {
    return new JUnit4TestAdapter(LoaderLogTest.class);
  }
}
