...
public class SessionHandlerTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    storageFile = env.get("WORKSPACE")+ File.separator + "storageFile";
  ...
  public void testSessionHandlerLog() throws Exception {
    ...
    final String expected = "sessionID\tbatchID\tdateID\tLOADED\tfilename\t1970-01-12_14:46:40\t1970-01-24_04:33:20\tsource\tstatus\t1970-02-04_18:20:00\t0\t\t\t\t\t";
