...
public class DailyRotationFileHandlerTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    System.setProperty("LOG_DIR", homeDir + File.separator);
    logManager = LogManager.getLogManager();
    SimpleDateFormat sdf = new SimpleDateFormat("yyyy_MM_dd");

    try {
      logPropertiesFile = new File(homeDir, "logProperties");
      publishedLog = new File(homeDir + File.separator + "test" + sdf.format(new Date())
          + ".log");
