...
public class DefaultLicensingCacheTest {
  ...
  public void setUp() throws Exception {
    ...
    testInstance = new DefaultLicensingCache(mockLicenseSettings, mockFeatureMapper, cache, true);
  }
    ...
    context.checking(new Expectations() {
      {
        ...
        allowing(mockFeatureInfo).getDeathDay();
        will(returnValue(WLSApi.VLS_NO_EXPIRATION));
 ...
 //   final MappingDescriptor md = null;
  ...
  public void testCheckCapacityLicenseCacheIsNull() throws Exception {
    ...
    testInstance = new DefaultLicensingCache(mockLicenseSettings, mockFeatureMapper, null, true);
