...
public class DefaultLicenseInformation implements LicenseInformation {
   ...
   * @param server
   */
  public DefaultLicenseInformation(String cxcNumber, String fajNumber, String description, long deathday,
      long birthday, String server) {
    this.server = server;
   ...
   */
  public DefaultLicenseInformation(String cxcNumber, String fajNumber, String description, long deathday,
      long birthday, String server, int capacity) {
    this.server = server;
    this.birthday = birthday;
    this.deathday = deathday;
    this.description = description;
