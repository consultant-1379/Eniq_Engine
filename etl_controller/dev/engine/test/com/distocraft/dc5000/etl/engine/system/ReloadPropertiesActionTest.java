...
public class ReloadPropertiesActionTest {

  private static ReloadPropertiesAction rpa = null;
  ...
  public static void init() {
	final String userHome = env.get("WORKSPACE");
    ...
    try {
      ...
      e.printStackTrace();
      fail("init() failed, RockFactory SQLException");
    ...
    try {
      rpa = new ReloadPropertiesAction(version, collectionSetId, collection, transferActionId, transferBatchId,
  ...
  /*public static junit.framework.Test suite() {
    return new JUnit4TestAdapter(ReloadPropertiesActionTest.class);
  }*/
}
