...
public class ChangeProfileActionTest {
  ...
  public static void init() {
    ...
    try {   
      cpa = new ChangeProfileAction(version, collectionSetId, collection, transferActionId, transferBatchId,connectId, rockFact, trActions);
  ...
  /*public static junit.framework.Test suite() {
    return new JUnit4TestAdapter(ChangeProfileActionTest.class);
  }*/
}
