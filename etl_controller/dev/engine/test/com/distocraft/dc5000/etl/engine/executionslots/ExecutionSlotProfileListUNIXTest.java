...
/**
 * This class extends ExecutionSlotProfileListTest. It is for running in UNIX / CI Server. The parent class has some tests that fail on UNIX / CI Server 
 ...
 * @author edeamai
 */
public class ExecutionSlotProfileListUNIXTest extends ExecutionSlotProfileListTest {
