...
public class Sequence 
{
	...
	private long curID;
	private long resID;
	static int IDPOOLSIZE = 50;
	//TODO get IDPOOL from property 
	private static Sequence singletonSequence = null;  
	
	/**
	 * At first call a Sequence is created.
	 * After fist call the same sequence is returned.
	 * 
	 * 
	 * @return
	 */
	public synchronized static Sequence instance() throws Exception
	{
	 ...
	 *
	 */
	private Sequence()  throws Exception
	{
		this.reserveIDs();
	}
	 ...
	 * @throws Exception
	 */
	private void reserveIDs() throws Exception 
	{
	
		try 
		{
			//TODO get ID filename from property
			BufferedReader br = new BufferedReader(new FileReader("IDs.info"));
		...
		try 
		{
			BufferedWriter bw = new BufferedWriter(new FileWriter("IDs.info"));
		...
		{
			throw new Exception("Cannot write ID file ",e);
		}
