...
public class SetExecuterRunnable implements Runnable {
  ...
  private SetListener setListener = SetListener.NULL; 
  private EngineThread et;
  private TransferEngine tEngine;
  private Properties props;
  
  private final static String PROPERTY_PROFILE = "engine.profile.before.execution";
  
  @Deprecated
  public SetExecuterRunnable(String colSetName, String colName, Properties props, SetListener setListener, EngineThread et, TransferEngine transferEngine) {
    this.props = props;
  ...
  public SetExecuterRunnable(Properties props, SetListener setListener, EngineThread et, TransferEngine transferEngine) {
    this.props = props;
    this.setListener = setListener;
    this.et = et;
    this.tEngine = transferEngine;
  ...
  public void run() {
    ...
    if(props!=null){
      String profile = props.getProperty(PROPERTY_PROFILE, "NO_VALUE");
