...
public class DWHMVersionUpdateAction extends SQLOperation {
  ...
  public DWHMVersionUpdateAction(Meta_versions version, Long techPackId, Meta_collections set, Long transferActionId,
  ...
  public void execute() throws Exception {
    ...
    try {
      ...
      VersionUpdateAction vua = new VersionUpdateAction(dwhreprock,dwhrock,tpName,log);
      vua.execute();
