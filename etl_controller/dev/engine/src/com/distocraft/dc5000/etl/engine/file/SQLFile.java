    ...
    */
    public SQLFile( 
        ...
        try {
            ...
            this.metaFiles = new Meta_files( rockFact,
                                        (Long)null,
                                        collectionSetId,
            ...
            if (this.fileName == null) {
                throw new EngineMetaDataException(  EngineConstants.NO_FILE_NAME,
                                                    null,
                                                    this,
            ...
            String sourceType = this.metaFiles.getFile_content_type();
