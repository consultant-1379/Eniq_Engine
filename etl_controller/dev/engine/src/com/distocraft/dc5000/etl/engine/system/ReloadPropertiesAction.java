 ...
 * 
 */
public class ReloadPropertiesAction extends TransferActionBase {
    ...
    *
    */
    protected ReloadPropertiesAction() {
    }
    /** 
    *  Constructor
    *  
    ...
    *
    */
    public ReloadPropertiesAction(  Meta_versions      version,
    ...
    */    
	...
	{       	
    	...
    	try {
    		        ...
    		        Logger.getLogger(this.logString+".execute").log(Level.INFO,"Reloading properties.");  		            		       		        
    		        admin.reloadProperties();
   		        
		}
    	catch (Exception e)
		{
            throw new EngineException(  "Exception in ReloadPropertiesAction",
                    new String[]{""},
                    e,
                    this,
