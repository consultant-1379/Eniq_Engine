 ...
 *
 * original author  Pekka Kaarela, modified to Dagger Engine project Jukka Jääheimo
 *
...
public class EngineBaseException extends Exception {
    ...
    */
    ...
    protected EngineBaseException(String s) {
        super(s);
    }
    ...
    */    
    ...
    /**  
    * This method converts the stack trace to string representation
    *
    * @return stack trace
    */
    ...
    */    
    ...
    public String getErrorMessage(){
        ...
        if ((this.getParams()!= null) && (this.getParams().length>0)) {
            return MessageFormat.format(this.errorMessage,this.getParams());
        }
        else {
    ...
    /**
	 * Return the error type of the exception. If in the exception hierarchy
	 * there is a SQLException or RockException, a SQL error type is returned.
	 * 
	 * @return 
	 */
