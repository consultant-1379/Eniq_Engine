...
public class SetListenerManager {
	...
	private HashMap<Long, SetListener> setListeners;
	...
	/**
	 * Stores the listener to the listener manager, and returns an id number
	 * that can be used to access the stored listener.
	 * 
	 * @param listener
	 * @return
	 */
	public long addListener(SetListener listener) {
		long listenerId = nextKey++; 
	 ...
	 * 		   null.
	 */
	public SetListener get(long listenerId) {
	 ...
	 * @param listenerId
	 */
	public void remove(long listenerId) {
