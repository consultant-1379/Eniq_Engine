...
public class Plugin extends TransferActionBase {
     ...
     * @param collectionSetId collectionSetId (transfer group)
     * @param collection collection (transfer set)
     * @param transferActionId
     * @param connectionId
     * @param rockFact connection to the repository
     * @param trActions all the transfer actions of this transfer set
	 */
    public Plugin(
        ...
        try{
            Meta_plugins plugin = new Meta_plugins( rockFact,
                                        (Long)null,
                                        collectionSetId,
                                        collection.getCollection_id(),
                                        //version.getVersion_number(),
                                        collection.getVersion_number(),
                                        transferActionId);
            ...
            Class pluginClass = pLoader.loadClass( plugin.getPlugin_name());
            Constructor pluginConstr = pluginClass.getConstructor(toClassArray(plugin.getConstructor_parameter()));
            m_plugin = (PluginClass) pluginConstr.newInstance(stringToArray(plugin.getConstructor_parameter()));
        }catch (Exception e) {             
			 throw new EngineMetaDataException(  "Plugin init exception ! ,"+
                                                e.getMessage()+" , "+e+"\n" +
                                                " Possible cause - wrong plugin parameters.",
    ...
    */
    public void execute() throws EngineException {
          try {
            ...
            //this.writeDebug("Executing plugin: "+m_plugin.getClass());
            ...
            if (m_plugin !=null) {
                ...
                throw new EngineException(  "Plugin Exception!",
                                            new String[]{"Plugin: "+m_plugin.getClass()},
                                            e,
                                            this,
                                            this.getClass().getName(),
...
//                throw new EngineException(  "Engine Meta Data Exception!",
//                                            new String[]{"Plugin: "+m_plugin.getClass()},
//                                            e,
//                                            this,
//                                            this.getClass().getName(),
...
//		}
     ...
     * @return Class[]
     */
    private Class[] toClassArray(String parameters) {
     ...
     * @return Object[]
     */
    private Object[] stringToArray(String parameters) {
