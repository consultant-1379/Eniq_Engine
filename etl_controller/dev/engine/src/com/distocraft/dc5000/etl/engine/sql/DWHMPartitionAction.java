...
public class DWHMPartitionAction extends SQLOperation {
  ...
  public DWHMPartitionAction(Meta_versions version, Long techPackId, Meta_collections set, Long transferActionId,
  ...
  public void execute() throws Exception {
    ...
    try {
      ...
      PartitionAction pa = new PartitionAction(dwhreprock, dwhrock, tpName, log);
