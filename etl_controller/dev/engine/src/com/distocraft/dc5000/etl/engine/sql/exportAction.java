...
public class exportAction extends SQLOperation {
  ...
  public exportAction(Meta_versions      version,
  ...
  public void execute() throws EngineException {
    ...
    try {
    	...
    	ETLCExport exportAgg = new ETLCExport(prop,connection);
        StringWriter sw = exportAgg.exportXml("");
        
        sctx.put("exportData",sw.toString());
        
    	
    } catch (Exception e) {
      log.log(java.util.logging.Level.WARNING, "Could Not Export Table(s)", e);
    } finally {
