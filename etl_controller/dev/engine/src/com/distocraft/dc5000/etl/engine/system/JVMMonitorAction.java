...
public class JVMMonitorAction extends TransferActionBase {
  ...
  private static Logger log = Logger.getLogger("etlengine.JVMMonitor");
   ...
   * 
   */
  public JVMMonitorAction(Meta_versions version, Long collectionSetId, Meta_collections collection,
  ...
  public void execute() throws EngineException {
    ...
    try {
      ...
      log.fine(rt.availableProcessors()+" processors "+max+" MB memory. "+allocated+" MB allocated "+free+" MB free.");
    
    } catch(Throwable t) {
      log.log(Level.INFO,"Monitor failed",t);
    }
