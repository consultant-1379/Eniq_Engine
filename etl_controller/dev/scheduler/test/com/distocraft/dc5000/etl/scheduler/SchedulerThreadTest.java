...
public class SchedulerThreadTest {
  ...
  //public static String portNum = "1000";   //For Windows
  public static String portNum = "1200";  //For CI
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    ITransferEngineRMIStub transferEngine = new ITransferEngineRMIStub();

    // Reflecting methods that are used only in single test
    try {
      objUnderTest = new SchedulerThread(1L, 1, "//localhost:"+portNum+"/Engine", 1L, "jdbc:hsqldb:mem:testdb",
  ...
  public void testMakeThreads() throws Exception {
    ...
    stmt.executeUpdate("INSERT INTO META_SCHEDULINGS VALUES"
        ...
        + " '1999-12-40 00:00:00.0', NULL, 1, 'testschedule2', 'N', 1, 2001, 'triggercommand',9)");
    stmt.executeUpdate("INSERT INTO META_SCHEDULINGS VALUES"
  ...
  public void testTriggerSet() throws Exception {
    ...
    RockFactory rf = new RockFactory("jdbc:hsqldb:mem:testdb", "sa", "", "org.hsqldb.jdbcDriver", "con", false);
