...
public class SchedulerAdminTest {
  ...
  public SchedulerAdminTest() throws Exception {
    ...
    ISchedulerRMIStub scheduler = new ISchedulerRMIStub(this);
  }
  ...
  public void testChangeScheduleStatus() throws Exception {
    ...
    assertEquals(true, changeScheduleStatus.invoke(objUnderTest, new Object[] { "disable_schedule", "techpack",
        "testschedule1" }));
    assertEquals(true, changeScheduleStatus.invoke(objUnderTest, new Object[] { "enable_schedule", "techpack",
        "testschedule2" }));
    ...
    IDataSet expectedDataSet = new FlatXmlDataSet(new File(
        "test/XMLFiles/com.distocraft.dc5000.etl.schedulerAdmin_testChangeScheduleStatus/Expected.xml"));
