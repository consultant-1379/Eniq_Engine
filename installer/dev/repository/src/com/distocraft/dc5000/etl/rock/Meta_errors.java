...
public class Meta_errors implements Cloneable,RockDBObject  {
  ...
  public Meta_errors(RockFactory rockFact) {
  	this(rockFact, false);
  }
   ...
   */
  public Meta_errors(RockFactory rockFact, boolean validate) {
   ...
   */
  public Meta_errors(RockFactory rockFact   ,Long ID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      if (it.hasNext()) {
        Meta_errors o = (Meta_errors) it.next();

              this.ID = o.getId();
              this.TEXT = o.getText();
              this.METHOD_NAME = o.getMethod_name();
              this.ERR_TYPE = o.getErr_type();
        ...
        results.close();
        throw new SQLException(FactoryRes.CANNOT_GET_TABLE_DATA + "Meta_errors");
      }
   ...
   * @exception SQLException
   */
  public Meta_errors(RockFactory rockFact, Meta_errors whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Meta_errors whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Meta_errors whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void saveDB() throws SQLException, RockException {
    ...
    if (this.newItem) {
      ...
      if (isPrimaryDefined()) {
        ...
        throw new RockException("Cannot use rock.Meta_errors.saveDB(), no primary key defined");
      }
    }
    this.newItem = false;
  }
  ...
  public void removeNulls() {
   ...
   public void setMethod_name(String METHOD_NAME) {
    if (validateData){
      DataValidator.validateData((Object)METHOD_NAME,"METHOD_NAME",12,100,0);
    }
    modifiedColumns.add("METHOD_NAME");
    this.METHOD_NAME = METHOD_NAME;
  }
   public void setErr_type(String ERR_TYPE) {
    if (validateData){
      DataValidator.validateData((Object)ERR_TYPE,"ERR_TYPE",12,30,0);
    }
    modifiedColumns.add("ERR_TYPE");
  ...
  public boolean equals(Meta_errors o) {

         if ((((this.ID == null) || (o.ID == null)) && (this.ID != o.ID))
            || (((this.TEXT == null) || (o.TEXT == null)) && (this.TEXT != o.TEXT))
            || (((this.METHOD_NAME == null) || (o.METHOD_NAME == null)) && (this.METHOD_NAME != o.METHOD_NAME))
            || (((this.ERR_TYPE == null) || (o.ERR_TYPE == null)) && (this.ERR_TYPE != o.ERR_TYPE))
    ...
    return false;
         ...
         if ((((this.ID != null) && (o.ID != null)) && (this.ID.equals(o.ID) == false))
            ...
            || (((this.METHOD_NAME != null) && (o.METHOD_NAME != null)) && (this.METHOD_NAME.equals(o.METHOD_NAME) == false))
            || (((this.ERR_TYPE != null) && (o.ERR_TYPE != null)) && (this.ERR_TYPE.equals(o.ERR_TYPE) == false))
  ...
  * return 100
  */
  public static int getMethod_nameColumnSize() {
  ...
  * return 0
  */
  public static int getMethod_nameDecimalDigits() {
  ...
  * return 12
  */
  public static int getMethod_nameSQLType() {
  ...
  * return 30
  */
  public static int getErr_typeColumnSize() {
  ...
  * return 0
  */
  public static int getErr_typeDecimalDigits() {
  ...
  * return 12
  */
  public static int getErr_typeSQLType() {
