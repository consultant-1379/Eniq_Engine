...
public class Meta_plugins implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "PLUGIN_ID"    ,"COLLECTION_SET_ID"    ,"COLLECTION_ID"    ,"VERSION_NUMBER"    ,"TRANSFER_ACTION_ID"   };
  ...
  public Meta_plugins(RockFactory rockFact) {
  	this(rockFact, false);
  }
   ...
   */
  public Meta_plugins(RockFactory rockFact, boolean validate) {
   ...
   */
  public Meta_plugins(RockFactory rockFact   ,Long PLUGIN_ID ,Long COLLECTION_SET_ID ,Long COLLECTION_ID ,String VERSION_NUMBER ,Long TRANSFER_ACTION_ID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      if (it.hasNext()) {
        Meta_plugins o = (Meta_plugins) it.next();
   ...
   * @exception SQLException
   */
  public Meta_plugins(RockFactory rockFact, Meta_plugins whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Meta_plugins whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Meta_plugins whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
     ...
     if (PLUGIN_NAME == null)
      PLUGIN_NAME = new String ("");
     if (CONSTRUCTOR_PARAMETER == null)
      CONSTRUCTOR_PARAMETER = new String ("");
     if (IS_SOURCE == null)
  ...
  public boolean equals(Meta_plugins o) {
