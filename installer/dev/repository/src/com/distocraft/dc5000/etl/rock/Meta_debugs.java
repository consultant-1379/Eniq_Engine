...
public class Meta_debugs implements Cloneable,RockDBObject  {
  ...
  public Meta_debugs(RockFactory rockFact) {
  	this(rockFact, false);
  }
   ...
   */
  public Meta_debugs(RockFactory rockFact, boolean validate) {
   ...
   */
  public Meta_debugs(RockFactory rockFact   ,Long ID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      if (it.hasNext()) {
        Meta_debugs o = (Meta_debugs) it.next();
   ...
   * @exception SQLException
   */
  public Meta_debugs(RockFactory rockFact, Meta_debugs whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Meta_debugs whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Meta_debugs whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean equals(Meta_debugs o) {
