...
public class All_tab_columns implements Cloneable {
  ...
  private String[] primaryKeyNames = { "TABLE_NAME", "COLUMN_NAME" };
  ...
  public All_tab_columns(RockFactory rockFact, String dbLinkName) {
  ...
  public All_tab_columns(RockFactory rockFact, String TABLE_NAME, String COLUMN_NAME, String dbLinkName)
    ...
    try {
      ...
      if (it.hasNext()) {
        All_tab_columns o = (All_tab_columns) it.next();
  ...
  public All_tab_columns(RockFactory rockFact, All_tab_columns whereObject, String dbLinkName) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      this.setDbLinkName(dbLinkName);
  ...
  public boolean equals(All_tab_columns o) {
