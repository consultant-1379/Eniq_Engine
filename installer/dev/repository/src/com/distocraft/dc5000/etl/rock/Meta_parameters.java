...
public class Meta_parameters implements Cloneable,RockDBObject  {
  ...
  public Meta_parameters(RockFactory rockFact) {
  	this(rockFact, false);
  }
   ...
   */
  public Meta_parameters(RockFactory rockFact, boolean validate) {
   ...
   */
  public Meta_parameters(RockFactory rockFact   ,String VERSION_NUMBER ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      if (it.hasNext()) {
        Meta_parameters o = (Meta_parameters) it.next();
   ...
   * @exception SQLException
   */
  public Meta_parameters(RockFactory rockFact, Meta_parameters whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Meta_parameters whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Meta_parameters whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
     if (RB_SEGMENT_NAME == null)
      RB_SEGMENT_NAME = new String ("");
     if (USE_RB_SEGMENT_FLAG == null)
      USE_RB_SEGMENT_FLAG = new String ("");
     if (DEFAULT_ERROR_MAIL_ADDR == null)
      DEFAULT_ERROR_MAIL_ADDR = new String ("");
     if (DEFAULT_FAIL_MAIL_ADDR == null)
      DEFAULT_FAIL_MAIL_ADDR = new String ("");
     if (DEFAULT_BUG_ERROR_MAIL_ADDR == null)
      DEFAULT_BUG_ERROR_MAIL_ADDR = new String ("");
     ...
     if (TEMP_SUM_TABLESPACE == null)
      TEMP_SUM_TABLESPACE = new String ("");
     if (USE_TEMP_SUM_TABLESPACE_FLAG == null)
      USE_TEMP_SUM_TABLESPACE_FLAG = new String ("");
     if (BATCH_COLUMN_NAME == null)
      BATCH_COLUMN_NAME = new String ("");
     if (VERSION_NUMBER == null)
      VERSION_NUMBER = new String ("");
   }

   public void setRb_segment_name(String RB_SEGMENT_NAME) {
    if (validateData){
   ...
   public void setUse_rb_segment_flag(String USE_RB_SEGMENT_FLAG) {
    if (validateData){
   ...
   public void setDefault_error_mail_addr(String DEFAULT_ERROR_MAIL_ADDR) {
    if (validateData){
   ...
   public void setDefault_fail_mail_addr(String DEFAULT_FAIL_MAIL_ADDR) {
    if (validateData){
   ...
   public void setDefault_bug_error_mail_addr(String DEFAULT_BUG_ERROR_MAIL_ADDR) {
    if (validateData){
   ...
   public void setDefault_max_error_value(Long DEFAULT_MAX_ERROR_VALUE) {
    if (validateData){
   ...
   public void setDefault_max_fk_error_value(Long DEFAULT_MAX_FK_ERROR_VALUE) {
    if (validateData){
   ...
   public void setDefault_max_col_limit_value(Long DEFAULT_MAX_COL_LIMIT_VALUE) {
    if (validateData){
   ...
   public void setTemp_sum_tablespace(String TEMP_SUM_TABLESPACE) {
    if (validateData){
   ...
   public void setUse_temp_sum_tablespace_flag(String USE_TEMP_SUM_TABLESPACE_FLAG) {
    if (validateData){
   ...
   public void setBatch_column_name(String BATCH_COLUMN_NAME) {
    if (validateData){
  ...
  public boolean equals(Meta_parameters o) {
