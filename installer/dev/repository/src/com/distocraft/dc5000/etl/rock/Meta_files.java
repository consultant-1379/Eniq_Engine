...
public class Meta_files implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "FILE_ID"    ,"COLLECTION_SET_ID"    ,"COLLECTION_ID"    ,"VERSION_NUMBER"    ,"TRANSFER_ACTION_ID"   };
  ...
  public Meta_files(RockFactory rockFact) {
  	this(rockFact, false);
  }
   ...
   */
  public Meta_files(RockFactory rockFact, boolean validate) {
   ...
   */
  public Meta_files(RockFactory rockFact   ,Long FILE_ID ,Long COLLECTION_SET_ID ,Long COLLECTION_ID ,String VERSION_NUMBER ,Long TRANSFER_ACTION_ID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      if (it.hasNext()) {
        Meta_files o = (Meta_files) it.next();
   ...
   * @exception SQLException
   */
  public Meta_files(RockFactory rockFact, Meta_files whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Meta_files whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Meta_files whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
     ...
     if (FILE_CONTENT_TYPE == null)
      FILE_CONTENT_TYPE = new String ("");
     if (ROW_DELIM == null)
      ROW_DELIM = new String ("");
     if (COLUMN_DELIM == null)
      COLUMN_DELIM = new String ("");
   ...
   public void setRow_delim(String ROW_DELIM) {
    if (validateData){
   ...
   public void setColumn_delim(String COLUMN_DELIM) {
    if (validateData){
   ...
   public void setCommit_after_n_rows(Long COMMIT_AFTER_N_ROWS) {
    if (validateData){
  ...
  public boolean equals(Meta_files o) {
