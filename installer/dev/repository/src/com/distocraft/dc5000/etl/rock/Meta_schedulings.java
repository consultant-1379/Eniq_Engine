...
public class Meta_schedulings implements Cloneable,RockDBObject  {
  ...
  public Meta_schedulings(RockFactory rockFact) {
  	this(rockFact, false);
  }
   ...
   */
  public Meta_schedulings(RockFactory rockFact, boolean validate) {
   ...
   */
  public Meta_schedulings(RockFactory rockFact   ,Long ID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      if (it.hasNext()) {
        Meta_schedulings o = (Meta_schedulings) it.next();
   ...
   * @exception SQLException
   */
  public Meta_schedulings(RockFactory rockFact, Meta_schedulings whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Meta_schedulings whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Meta_schedulings whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
   ...
   public void setLast_exec_time_ms(Long LAST_EXEC_TIME_MS) {
    if (validateData){
      DataValidator.validateData((Object)LAST_EXEC_TIME_MS,"LAST_EXEC_TIME_MS",2,2,0);
    }
  ...
  public boolean equals(Meta_schedulings o) {
