...
public class User_constraints implements Cloneable {
   ...
   */
  public User_constraints(RockFactory rockFact) {
   ...
   */
  public User_constraints(RockFactory rockFact, String constraint_name) throws SQLException, RockException {
    try {
      this.rockFact = rockFact;
      ...
      if (it.hasNext()) {
        User_constraints o = (User_constraints) it.next();
   ...
   * @exception SQLException
   */
  public User_constraints(RockFactory rockFact, User_constraints whereObject) throws SQLException, RockException {
    try {
      this.rockFact = rockFact;
