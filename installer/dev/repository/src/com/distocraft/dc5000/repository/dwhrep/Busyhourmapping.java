...
public class Busyhourmapping implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "VERSIONID"    ,"BHLEVEL"    ,"BHTYPE"    ,"TARGETVERSIONID"    ,"BHOBJECT"    ,"TYPEID"   };
  ...
  public Busyhourmapping(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Busyhourmapping(RockFactory rockFact, boolean validate) {
   ...
   */
  public Busyhourmapping(RockFactory rockFact   ,String VERSIONID ,String BHLEVEL ,String BHTYPE ,String TARGETVERSIONID ,String BHOBJECT ,String TYPEID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Busyhourmapping> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Busyhourmapping o = (Busyhourmapping) it.next();
   ...
   * @exception SQLException
   */
  public Busyhourmapping(RockFactory rockFact, Busyhourmapping whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Busyhourmapping whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Busyhourmapping whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
     ...
     if (BHTARGETTYPE == null)
      BHTARGETTYPE = new String ("");
     if (BHTARGETLEVEL == null)
      BHTARGETLEVEL = new String ("");
     if (ENABLE == null)
   ...
   public void setBhtargettype(String BHTARGETTYPE) {
    if (validateData){
   ...
   public void setBhtargetlevel(String BHTARGETLEVEL) {
    if (validateData){
  ...
  public boolean dbEquals(Busyhourmapping o) {
  ...
  public boolean equals(Busyhourmapping o) {
  ...
  */
  ...
  public void setOriginal(Busyhourmapping original) {
