...
public class Verificationobject implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "VERSIONID"    ,"MEASLEVEL"    ,"OBJECTCLASS"    ,"OBJECTNAME"   };
  ...
  public Verificationobject(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Verificationobject(RockFactory rockFact, boolean validate) {
   ...
   */
  public Verificationobject(RockFactory rockFact   ,String VERSIONID ,String MEASLEVEL ,String OBJECTCLASS ,String OBJECTNAME ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Verificationobject> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Verificationobject o = (Verificationobject) it.next();
   ...
   * @exception SQLException
   */
  public Verificationobject(RockFactory rockFact, Verificationobject whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Verificationobject whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Verificationobject whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
   ...
   public void setMeaslevel(String MEASLEVEL) {
    if (validateData){
  ...
  public boolean dbEquals(Verificationobject o) {
  ...
  public boolean equals(Verificationobject o) {
  ...
  */
  ...
  public void setOriginal(Verificationobject original) {
