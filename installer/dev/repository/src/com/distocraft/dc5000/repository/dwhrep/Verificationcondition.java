...
public class Verificationcondition implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "VERSIONID"    ,"VERLEVEL"    ,"CONDITIONCLASS"    ,"VERCONDITION"   };
  ...
  public Verificationcondition(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Verificationcondition(RockFactory rockFact, boolean validate) {
   ...
   */
  public Verificationcondition(RockFactory rockFact   ,String VERSIONID ,String VERLEVEL ,String CONDITIONCLASS ,String VERCONDITION ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Verificationcondition> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Verificationcondition o = (Verificationcondition) it.next();
   ...
   * @exception SQLException
   */
  public Verificationcondition(RockFactory rockFact, Verificationcondition whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      Iterator<Verificationcondition> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        Verificationcondition o = (Verificationcondition) it.next();
                this.VERSIONID = o.getVersionid();
                this.FACTTABLE = o.getFacttable();
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Verificationcondition whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Verificationcondition whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
     ...
     if (FACTTABLE == null)
      FACTTABLE = new String ("");
     if (VERLEVEL == null)
      VERLEVEL = new String ("");
     if (CONDITIONCLASS == null)
      CONDITIONCLASS = new String ("");
     if (VERCONDITION == null)
      VERCONDITION = new String ("");
     if (PROMPTNAME1 == null)
      PROMPTNAME1 = new String ("");
     if (PROMPTVALUE1 == null)
      PROMPTVALUE1 = new String ("");
     if (PROMPTNAME2 == null)
      PROMPTNAME2 = new String ("");
     if (PROMPTVALUE2 == null)
      PROMPTVALUE2 = new String ("");
     if (OBJECTCONDITION == null)
      OBJECTCONDITION = new String ("");
     if (PROMPTNAME3 == null)
      PROMPTNAME3 = new String ("");
     if (PROMPTVALUE3 == null)
      PROMPTVALUE3 = new String ("");
   }
   ...
   public void setPromptname1(String PROMPTNAME1) {
    if (validateData){
   ...
   public void setPromptname2(String PROMPTNAME2) {
    if (validateData){
   ...
   public void setPromptname3(String PROMPTNAME3) {
    if (validateData){
  ...
  public boolean dbEquals(Verificationcondition o) {
  ...
  public boolean equals(Verificationcondition o) {
  ...
  */
  ...
  public void setOriginal(Verificationcondition original) {
