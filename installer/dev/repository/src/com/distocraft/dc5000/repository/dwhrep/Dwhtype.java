...
public class Dwhtype implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "STORAGEID"   };
  ...
  public Dwhtype(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Dwhtype(RockFactory rockFact, boolean validate) {
   ...
   */
  public Dwhtype(RockFactory rockFact   ,String STORAGEID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Dwhtype> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Dwhtype o = (Dwhtype) it.next();
   ...
   * @exception SQLException
   */
  public Dwhtype(RockFactory rockFact, Dwhtype whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      Iterator<Dwhtype> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        Dwhtype o = (Dwhtype) it.next();
                this.TECHPACK_NAME = o.getTechpack_name();
                this.TYPENAME = o.getTypename();
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Dwhtype whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Dwhtype whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
   ...
   public void setNextpartitiontime(Timestamp NEXTPARTITIONTIME) {
    if (validateData){
   ...
   public void setDatadatecolumn(String DATADATECOLUMN) {
    if (validateData){
   ...
   public void setPublicviewtemplate(String PUBLICVIEWTEMPLATE) {
    if (validateData){
  ...
  public boolean dbEquals(Dwhtype o) {
  ...
  public boolean equals(Dwhtype o) {
  ...
  */
  ...
  public void setOriginal(Dwhtype original) {
