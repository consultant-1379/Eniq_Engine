...
public class Measurementdeltacalcsupport implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "TYPEID"    ,"VENDORRELEASE"    ,"VERSIONID"   };
  ...
  public Measurementdeltacalcsupport(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Measurementdeltacalcsupport(RockFactory rockFact, boolean validate) {
   ...
   */
  public Measurementdeltacalcsupport(RockFactory rockFact   ,String TYPEID ,String VENDORRELEASE ,String VERSIONID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Measurementdeltacalcsupport> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Measurementdeltacalcsupport o = (Measurementdeltacalcsupport) it.next();
   ...
   * @exception SQLException
   */
  public Measurementdeltacalcsupport(RockFactory rockFact, Measurementdeltacalcsupport whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Measurementdeltacalcsupport whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Measurementdeltacalcsupport whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(Measurementdeltacalcsupport o) {
  ...
  public boolean equals(Measurementdeltacalcsupport o) {
  ...
  */
  ...
  public void setOriginal(Measurementdeltacalcsupport original) {
