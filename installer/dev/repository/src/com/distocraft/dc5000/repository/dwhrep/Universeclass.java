...
public class Universeclass implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "VERSIONID"    ,"CLASSNAME"    ,"UNIVERSEEXTENSION"   };
  ...
  public Universeclass(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Universeclass(RockFactory rockFact, boolean validate) {
   ...
   */
  public Universeclass(RockFactory rockFact   ,String VERSIONID ,String CLASSNAME ,String UNIVERSEEXTENSION ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Universeclass> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Universeclass o = (Universeclass) it.next();
   ...
   * @exception SQLException
   */
  public Universeclass(RockFactory rockFact, Universeclass whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      Iterator<Universeclass> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        Universeclass o = (Universeclass) it.next();
                this.VERSIONID = o.getVersionid();
                this.CLASSNAME = o.getClassname();
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Universeclass whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Universeclass whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(Universeclass o) {
  ...
  public boolean equals(Universeclass o) {
  ...
  */
  ...
  public void setOriginal(Universeclass original) {
