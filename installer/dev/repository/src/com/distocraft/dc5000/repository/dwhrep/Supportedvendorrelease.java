...
public class Supportedvendorrelease implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "VERSIONID"    ,"VENDORRELEASE"   };
  ...
  private Supportedvendorrelease original; 

  public Supportedvendorrelease(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Supportedvendorrelease(RockFactory rockFact, boolean validate) {
   ...
   */
  public Supportedvendorrelease(RockFactory rockFact   ,String VERSIONID ,String VENDORRELEASE ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Supportedvendorrelease> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Supportedvendorrelease o = (Supportedvendorrelease) it.next();
        ...
        results.close();
  	    this.original = this; 
        throw new SQLException(FactoryRes.CANNOT_GET_TABLE_DATA + "Supportedvendorrelease");
      }
   ...
   * @exception SQLException
   */
  public Supportedvendorrelease(RockFactory rockFact, Supportedvendorrelease whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      Iterator<Supportedvendorrelease> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        Supportedvendorrelease o = (Supportedvendorrelease) it.next();
                this.VERSIONID = o.getVersionid();
                this.VENDORRELEASE = o.getVendorrelease();
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Supportedvendorrelease whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Supportedvendorrelease whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void saveDB() throws SQLException, RockException {
    ...
    if (this.newItem) {
      ...
      if (isPrimaryDefined()) {
        ...
        throw new RockException("Cannot use rock.Supportedvendorrelease.saveDB(), no primary key defined");
      }
    }
    this.newItem = false;
   ...
   */
    ...
    sbuff.append("<Supportedvendorrelease ");
  ...
  public String toSQLInsert(){
    ...
    StringBuffer sbuff = new StringBuffer();
    sbuff.append("insert into Supportedvendorrelease ( ");
  ...
  public boolean dbEquals(Supportedvendorrelease o) {
  ...
  public boolean equals(Supportedvendorrelease o) {
  ...
  */
  ...
  public Supportedvendorrelease getOriginal() {
    return original;
  }
   
  public void setOriginal(Supportedvendorrelease original) {
    this.original = (Supportedvendorrelease) original.clone();
  }
