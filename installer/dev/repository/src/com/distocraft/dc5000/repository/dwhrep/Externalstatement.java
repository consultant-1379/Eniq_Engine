...
public class Externalstatement implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "VERSIONID"    ,"STATEMENTNAME"    ,"BASEDEF"   };
  ...
  public Externalstatement(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Externalstatement(RockFactory rockFact, boolean validate) {
   ...
   */
  public Externalstatement(RockFactory rockFact   ,String VERSIONID ,String STATEMENTNAME ,Integer BASEDEF ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Externalstatement> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Externalstatement o = (Externalstatement) it.next();
   ...
   * @exception SQLException
   */
  public Externalstatement(RockFactory rockFact, Externalstatement whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Externalstatement whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Externalstatement whereObject) throws SQLException, RockException {
    this.newItem = true;
   ...
   */
    ...
    sbuff.append("<Externalstatement ");
        ...
        sbuff.append("STATEMENT=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.STATEMENT),12, true)+"\" ");
  ...
  public String toSQLInsert(){
    ...
    sbuff.append("insert into Externalstatement ( ");
	        ...
	        sbuff.append(" ) values ( ");
    	        ...
    	        sbuff.append(", "+DataValidator.wrap(""+this.STATEMENT,12)+"");
  ...
  public void removeNulls() {
   ...
   public void setStatement(String STATEMENT) {
    if (validateData){
      DataValidator.validateData((Object)STATEMENT,"STATEMENT",12,32000,0);
    }
  ...
  public boolean dbEquals(Externalstatement o) {
  ...
  public boolean equals(Externalstatement o) {
  ...
  */
  ...
  public void setOriginal(Externalstatement original) {
