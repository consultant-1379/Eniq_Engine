...
public class Measurementobjbhsupport implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "TYPEID"    ,"OBJBHSUPPORT"   };
  ...
  public Measurementobjbhsupport(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Measurementobjbhsupport(RockFactory rockFact, boolean validate) {
   ...
   */
  public Measurementobjbhsupport(RockFactory rockFact   ,String TYPEID ,String OBJBHSUPPORT ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Measurementobjbhsupport> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Measurementobjbhsupport o = (Measurementobjbhsupport) it.next();
   ...
   * @exception SQLException
   */
  public Measurementobjbhsupport(RockFactory rockFact, Measurementobjbhsupport whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Measurementobjbhsupport whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Measurementobjbhsupport whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
   ...
   public void setObjbhsupport(String OBJBHSUPPORT) {
    if (validateData){
  ...
  public boolean dbEquals(Measurementobjbhsupport o) {
  ...
  public boolean equals(Measurementobjbhsupport o) {
  ...
  */
  ...
  public void setOriginal(Measurementobjbhsupport original) {
