...
public class Typeactivation implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "TECHPACK_NAME"    ,"TYPENAME"    ,"TABLELEVEL"   };
  ...
  public Typeactivation(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Typeactivation(RockFactory rockFact, boolean validate) {
   ...
   */
  public Typeactivation(RockFactory rockFact   ,String TECHPACK_NAME ,String TYPENAME ,String TABLELEVEL ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Typeactivation> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Typeactivation o = (Typeactivation) it.next();
   ...
   * @exception SQLException
   */
  public Typeactivation(RockFactory rockFact, Typeactivation whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Typeactivation whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Typeactivation whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
   ...
   public void setStoragetime(Long STORAGETIME) {
    if (validateData){
      DataValidator.validateData((Object)STORAGETIME,"STORAGETIME",2,9,0);
    }
  ...
  public boolean dbEquals(Typeactivation o) {
  ...
  public boolean equals(Typeactivation o) {
  ...
  */
  ...
  public void setOriginal(Typeactivation original) {
