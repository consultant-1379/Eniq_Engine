...
public class Measurementcounter implements Cloneable,RockDBObject  {
   ...
   */
  public Measurementcounter(RockFactory rockFact, boolean validate) {
   ...
   */
  public Measurementcounter(RockFactory rockFact   ,String TYPEID ,String DATANAME ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Measurementcounter> it = rockFact.getData(this, results);
      if (it.hasNext()) {
   ...
   * @exception SQLException
   */
  public Measurementcounter(RockFactory rockFact, Measurementcounter whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      Iterator<Measurementcounter> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        Measurementcounter o = (Measurementcounter) it.next();
                this.TYPEID = o.getTypeid();
                this.DATANAME = o.getDataname();
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Measurementcounter whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Measurementcounter whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
     ...
     if (UNIVOBJECT == null)
      UNIVOBJECT = new String ("");
     if (UNIVCLASS == null)
      UNIVCLASS = new String ("");
     if (COUNTERTYPE == null)
      COUNTERTYPE = new String ("");
     if (COUNTERPROCESS == null)
      COUNTERPROCESS = new String ("");
     if (DATAID == null)
      DATAID = new String ("");
     if (FOLLOWJOHN == null)
   ...
   public void setUnivobject(String UNIVOBJECT) {
    if (validateData){
   ...
   public void setCounterprocess(String COUNTERPROCESS) {
    if (validateData){
  ...
  public boolean dbEquals(Measurementcounter o) {
  ...
  */
  ...
  public void setOriginal(Measurementcounter original) {
