...
public class Externalstatementstatus implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "TECHPACK_NAME"    ,"STATEMENTNAME"    ,"VERSIONID"   };
  ...
  public Externalstatementstatus(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Externalstatementstatus(RockFactory rockFact, boolean validate) {
   ...
   */
  public Externalstatementstatus(RockFactory rockFact   ,String TECHPACK_NAME ,String STATEMENTNAME ,String VERSIONID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Externalstatementstatus> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Externalstatementstatus o = (Externalstatementstatus) it.next();
   ...
   * @exception SQLException
   */
  public Externalstatementstatus(RockFactory rockFact, Externalstatementstatus whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Externalstatementstatus whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Externalstatementstatus whereObject) throws SQLException, RockException {
    this.newItem = true;
   ...
   */
    ...
    sbuff.append("<Externalstatementstatus ");
        ...
        sbuff.append("EXECSTATEMENT=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.EXECSTATEMENT),12, true)+"\" ");
  ...
  public String toSQLInsert(){
    ...
    sbuff.append("insert into Externalstatementstatus ( ");
	        ...
	        sbuff.append(" ) values ( ");
    	        ...
    	        sbuff.append(", "+DataValidator.wrap(""+this.EXECSTATEMENT,12)+"");
    	    sbuff.append(" );\n");   
    return sbuff.toString();
  }
  ...
  public void removeNulls() {
   ...
   public void setExecstatement(String EXECSTATEMENT) {
    if (validateData){
      DataValidator.validateData((Object)EXECSTATEMENT,"EXECSTATEMENT",12,32000,0);
    }
  ...
  public boolean dbEquals(Externalstatementstatus o) {
  ...
  public boolean equals(Externalstatementstatus o) {
  ...
  */
  ...
  public void setOriginal(Externalstatementstatus original) {
