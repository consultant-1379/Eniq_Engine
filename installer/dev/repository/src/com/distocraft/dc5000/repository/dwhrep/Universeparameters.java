...
public class Universeparameters implements Cloneable,RockDBObject  {

    private String VERSIONID;
    private String CLASSNAME;
    private String OBJECTNAME;
    private String UNIVERSEEXTENSION;
    private Integer ORDERNRO;
    private String NAME;
  ...
  private String[] primaryKeyNames = {    "VERSIONID"    ,"CLASSNAME"    ,"OBJECTNAME"    ,"UNIVERSEEXTENSION"    ,"ORDERNRO"   };
  ...
  private Universeparameters original; 

  public Universeparameters(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Universeparameters(RockFactory rockFact, boolean validate) {
   ...
   */
  public Universeparameters(RockFactory rockFact   ,String VERSIONID ,String CLASSNAME ,String OBJECTNAME ,String UNIVERSEEXTENSION ,Integer ORDERNRO ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Universeparameters> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Universeparameters o = (Universeparameters) it.next();
        ...
        results.close();
  	    this.original = this; 
        throw new SQLException(FactoryRes.CANNOT_GET_TABLE_DATA + "Universeparameters");
      }
   ...
   * @exception SQLException
   */
  public Universeparameters(RockFactory rockFact, Universeparameters whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      Iterator<Universeparameters> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        Universeparameters o = (Universeparameters) it.next();
                this.VERSIONID = o.getVersionid();
                this.CLASSNAME = o.getClassname();
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Universeparameters whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Universeparameters whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void saveDB() throws SQLException, RockException {
    ...
    if (this.newItem) {
      ...
      if (isPrimaryDefined()) {
        ...
        throw new RockException("Cannot use rock.Universeparameters.saveDB(), no primary key defined");
      }
    }
    this.newItem = false;
   ...
   */
    ...
    sbuff.append("<Universeparameters ");
        ...
        sbuff.append("ORDERNRO=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.ORDERNRO),4, true)+"\" ");
  ...
  public String toSQLInsert(){
    ...
    StringBuffer sbuff = new StringBuffer();
    sbuff.append("insert into Universeparameters ( ");
	        ...
	        sbuff.append(" ) values ( ");
    	        ...
    	        sbuff.append(", "+DataValidator.wrap(""+this.ORDERNRO,4)+"");
  ...
  public void removeNulls() {
   ...
   public void setOrdernro(Integer ORDERNRO) {
    if (validateData){
      DataValidator.validateData((Object)ORDERNRO,"ORDERNRO",4,10,0);
    }
  ...
  public boolean dbEquals(Universeparameters o) {
  ...
  public boolean equals(Universeparameters o) {
  ...
  */
  ...
  public Universeparameters getOriginal() {
    return original;
  }
   
  public void setOriginal(Universeparameters original) {
    this.original = (Universeparameters) original.clone();
  }
