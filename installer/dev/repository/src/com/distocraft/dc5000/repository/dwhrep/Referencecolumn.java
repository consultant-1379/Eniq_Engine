...
public class Referencecolumn implements Cloneable,RockDBObject  {
  ...
  public Referencecolumn(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Referencecolumn(RockFactory rockFact, boolean validate) {
   ...
   */
  public Referencecolumn(RockFactory rockFact   ,String TYPEID ,String DATANAME ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Referencecolumn> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Referencecolumn o = (Referencecolumn) it.next();
   ...
   * @exception SQLException
   */
  public Referencecolumn(RockFactory rockFact, Referencecolumn whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Referencecolumn whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Referencecolumn whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
     ...
     if (UNIVERSECLASS == null)
      UNIVERSECLASS = new String ("");
     if (UNIVERSEOBJECT == null)
      UNIVERSEOBJECT = new String ("");
   ...
   public void setIncludeupd(Integer INCLUDEUPD) {
    if (validateData){
   ...
   public void setUniverseclass(String UNIVERSECLASS) {
    if (validateData){
   ...
   public void setUniverseobject(String UNIVERSEOBJECT) {
    if (validateData){
  ...
  public boolean dbEquals(Referencecolumn o) {
  ...
  public boolean equals(Referencecolumn o) {
  ...
  */
  ...
  public void setOriginal(Referencecolumn original) {
