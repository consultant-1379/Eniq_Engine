...
public class Interfacemeasurement implements Cloneable,RockDBObject  {
  ...
  public Interfacemeasurement(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Interfacemeasurement(RockFactory rockFact, boolean validate) {
  ...
  public Interfacemeasurement(RockFactory rockFact   ,String TAGID ,String DATAFORMATID ,String INTERFACENAME ,String INTERFACEVERSION ) throws SQLException,
    ...
    try {
      ...
      Iterator<Interfacemeasurement> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Interfacemeasurement o = (Interfacemeasurement) it.next();
   ...
   * @exception SQLException
   */
  public Interfacemeasurement(RockFactory rockFact, Interfacemeasurement whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Interfacemeasurement whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Interfacemeasurement whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(Interfacemeasurement o) {
  ...
  public boolean equals(Interfacemeasurement o) {
  ...
  */
  ...
  public void setOriginal(Interfacemeasurement original) {
