...
public class Busyhour implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "VERSIONID"    ,"BHLEVEL"    ,"BHTYPE"    ,"TARGETVERSIONID"    ,"BHOBJECT"   };
  ...
  public Busyhour(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Busyhour(RockFactory rockFact, boolean validate) {
   ...
   */
  public Busyhour(RockFactory rockFact   ,String VERSIONID ,String BHLEVEL ,String BHTYPE ,String TARGETVERSIONID ,String BHOBJECT ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Busyhour> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Busyhour o = (Busyhour) it.next();
   ...
   * @exception SQLException
   */
  public Busyhour(RockFactory rockFact, Busyhour whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Busyhour whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Busyhour whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
   ...
   public void setBhcriteria(String BHCRITERIA) {
    if (validateData){
   ...
   public void setBhelement(Integer BHELEMENT) {
    if (validateData){
   ...
   public void setN_threshold(Integer N_THRESHOLD) {
    if (validateData){
   ...
   public void setReactivateviews(Integer REACTIVATEVIEWS) {
    if (validateData){
  ...
  public boolean dbEquals(Busyhour o) {
  ...
  public boolean equals(Busyhour o) {
  ...
  */
  ...
  public void setOriginal(Busyhour original) {
