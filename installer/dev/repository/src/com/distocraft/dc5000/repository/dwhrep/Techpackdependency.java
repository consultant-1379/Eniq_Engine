...
public class Techpackdependency implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "VERSIONID"    ,"TECHPACKNAME"   };
  ...
  private Techpackdependency original; 

  public Techpackdependency(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Techpackdependency(RockFactory rockFact, boolean validate) {
   ...
   */
  public Techpackdependency(RockFactory rockFact   ,String VERSIONID ,String TECHPACKNAME ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Techpackdependency> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Techpackdependency o = (Techpackdependency) it.next();
        ...
        results.close();
  	    this.original = this; 
        throw new SQLException(FactoryRes.CANNOT_GET_TABLE_DATA + "Techpackdependency");
      }
   ...
   * @exception SQLException
   */
  public Techpackdependency(RockFactory rockFact, Techpackdependency whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Techpackdependency whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Techpackdependency whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void saveDB() throws SQLException, RockException {
    ...
    if (this.newItem) {
      ...
      if (isPrimaryDefined()) {
        ...
        throw new RockException("Cannot use rock.Techpackdependency.saveDB(), no primary key defined");
      }
    }
    this.newItem = false;
   ...
   */
    ...
    sbuff.append("<Techpackdependency ");
        ...
        sbuff.append("VERSION=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.VERSION),12, true)+"\" ");
  ...
  public String toSQLInsert(){
    ...
    StringBuffer sbuff = new StringBuffer();
    sbuff.append("insert into Techpackdependency ( ");
	        ...
	        sbuff.append(" ) values ( ");
    	        ...
    	        sbuff.append(", "+DataValidator.wrap(""+this.VERSION,12)+"");
    	    sbuff.append(" );\n");   
    return sbuff.toString();
  }
  ...
  public void removeNulls() {
   ...
   public void setVersion(String VERSION) {
    if (validateData){
      DataValidator.validateData((Object)VERSION,"VERSION",12,32,0);
    }
  ...
  public boolean dbEquals(Techpackdependency o) {
  ...
  public boolean equals(Techpackdependency o) {
  ...
  */
  ...
  public Techpackdependency getOriginal() {
    return original;
  }
   
  public void setOriginal(Techpackdependency original) {
    this.original = (Techpackdependency) original.clone();
  }
