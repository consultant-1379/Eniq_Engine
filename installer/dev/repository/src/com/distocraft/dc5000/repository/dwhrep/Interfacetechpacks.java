...
public class Interfacetechpacks implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "INTERFACENAME"    ,"TECHPACKNAME"    ,"TECHPACKVERSION"    ,"INTERFACEVERSION"   };
  ...
  public Interfacetechpacks(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Interfacetechpacks(RockFactory rockFact, boolean validate) {
   ...
   */
  public Interfacetechpacks(RockFactory rockFact   ,String INTERFACENAME ,String TECHPACKNAME ,String TECHPACKVERSION ,String INTERFACEVERSION ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Interfacetechpacks> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Interfacetechpacks o = (Interfacetechpacks) it.next();
   ...
   * @exception SQLException
   */
  public Interfacetechpacks(RockFactory rockFact, Interfacetechpacks whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Interfacetechpacks whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Interfacetechpacks whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(Interfacetechpacks o) {
  ...
  public boolean equals(Interfacetechpacks o) {
  ...
  */
  ...
  public void setOriginal(Interfacetechpacks original) {
