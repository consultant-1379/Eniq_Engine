...
public class Alarminterface implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "INTERFACEID"   };
  ...
  public Alarminterface(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Alarminterface(RockFactory rockFact, boolean validate) {
   ...
   */
  public Alarminterface(RockFactory rockFact   ,String INTERFACEID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Alarminterface> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Alarminterface o = (Alarminterface) it.next();
   ...
   * @exception SQLException
   */
  public Alarminterface(RockFactory rockFact, Alarminterface whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Alarminterface whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Alarminterface whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
   ...
   public void setQueue_number(Long QUEUE_NUMBER) {
    if (validateData){
  ...
  public boolean dbEquals(Alarminterface o) {
  ...
  public boolean equals(Alarminterface o) {
  ...
  */
  ...
  public void setOriginal(Alarminterface original) {
