...
public class Aggregation implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "AGGREGATION"    ,"VERSIONID"   };
  ...
  public Aggregation(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Aggregation(RockFactory rockFact, boolean validate) {
   ...
   */
  public Aggregation(RockFactory rockFact   ,String AGGREGATION ,String VERSIONID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Aggregation> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Aggregation o = (Aggregation) it.next();
   ...
   * @exception SQLException
   */
  public Aggregation(RockFactory rockFact, Aggregation whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Aggregation whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Aggregation whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
   ...
   public void setAggregationset(String AGGREGATIONSET) {
    if (validateData){
   ...
   public void setReaggregationset(String REAGGREGATIONSET) {
    if (validateData){
   ...
   public void setReaggregationgroup(String REAGGREGATIONGROUP) {
    if (validateData){
   ...
   public void setAggregationorder(Integer AGGREGATIONORDER) {
    if (validateData){
  ...
  public boolean dbEquals(Aggregation o) {
  ...
  public boolean equals(Aggregation o) {
  ...
  */
  ...
  public void setOriginal(Aggregation original) {
