...
public class Versioning implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "VERSIONID"   };
  ...
  public Versioning(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Versioning(RockFactory rockFact, boolean validate) {
   ...
   */
  public Versioning(RockFactory rockFact   ,String VERSIONID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Versioning> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Versioning o = (Versioning) it.next();
   ...
   * @exception SQLException
   */
  public Versioning(RockFactory rockFact, Versioning whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Versioning whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Versioning whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
     ...
     if (TECHPACK_VERSION == null)
      TECHPACK_VERSION = new String ("");
     if (TECHPACK_TYPE == null)
      TECHPACK_TYPE = new String ("");
     if (PRODUCT_NUMBER == null)
      PRODUCT_NUMBER = new String ("");
     if (LOCKEDBY == null)
      LOCKEDBY = new String ("");
     if (LOCKDATE == null)
      LOCKDATE = new Timestamp (0);
     if (BASEDEFINITION == null)
      BASEDEFINITION = new String ("");
     if (BASEVERSION == null)
      BASEVERSION = new String ("");
     if (INSTALLDESCRIPTION == null)
      INSTALLDESCRIPTION = new String ("");
     if (UNIVERSENAME == null)
      UNIVERSENAME = new String ("");
     if (UNIVERSEEXTENSION == null)
      UNIVERSEEXTENSION = new String ("");
     if (ENIQ_LEVEL == null)
      ENIQ_LEVEL = new String ("");
     if (LICENSENAME == null)
      LICENSENAME = new String ("");
   }
   ...
   public void setLicensename(String LICENSENAME) {
    if (validateData){
      DataValidator.validateData((Object)LICENSENAME,"LICENSENAME",12,255,0);
    }
  ...
  public boolean dbEquals(Versioning o) {
  ...
  public boolean equals(Versioning o) {
  ...
  */
  ...
  public void setOriginal(Versioning original) {
