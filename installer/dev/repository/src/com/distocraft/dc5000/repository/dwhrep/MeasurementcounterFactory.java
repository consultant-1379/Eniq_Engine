...
public class MeasurementcounterFactory implements Cloneable {
  private Vector<Measurementcounter> vec;
  ...
  public MeasurementcounterFactory(RockFactory rockFact, Measurementcounter whereObject) throws SQLException,
    ...
    this.vec = new Vector<Measurementcounter>();
  ...
  public MeasurementcounterFactory(RockFactory rockFact, Measurementcounter whereObject, boolean validate) throws SQLException,
      RockException {
    this.whereObject = whereObject;
    ...
    RockResultSet results = rockFact.setSelectSQL(false, whereObject);
    Iterator<Measurementcounter> it = rockFact.getData(whereObject, results);
    Measurementcounter o = new Measurementcounter(rockFact, validate);
   ...
   */
  public Vector<Measurementcounter> get() {
    return vec;
  }
   ...
   * are equal.
   */
  public boolean equals(Vector<Measurementcounter> otherVector) {
    ...
    for (int i = 0; i < this.vec.size(); i++) {
      Measurementcounter o = (Measurementcounter) this.vec.elementAt(i);
      Measurementcounter otherO = (Measurementcounter) otherVector.elementAt(i);
