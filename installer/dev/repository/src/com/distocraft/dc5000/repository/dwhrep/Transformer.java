...
public class Transformer implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "TRANSFORMERID"   };
  ...
  public Transformer(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Transformer(RockFactory rockFact, boolean validate) {
   ...
   */
  public Transformer(RockFactory rockFact   ,String TRANSFORMERID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Transformer> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Transformer o = (Transformer) it.next();
   ...
   * @exception SQLException
   */
  public Transformer(RockFactory rockFact, Transformer whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Transformer whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Transformer whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(Transformer o) {
  ...
  public boolean equals(Transformer o) {
  ...
  */
  ...
  public void setOriginal(Transformer original) {
