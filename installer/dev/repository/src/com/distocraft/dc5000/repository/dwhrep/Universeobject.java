...
public class Universeobject implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "VERSIONID"    ,"CLASSNAME"    ,"UNIVERSEEXTENSION"    ,"OBJECTNAME"   };
  ...
  private Universeobject original; 

  public Universeobject(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Universeobject(RockFactory rockFact, boolean validate) {
   ...
   */
  public Universeobject(RockFactory rockFact   ,String VERSIONID ,String CLASSNAME ,String UNIVERSEEXTENSION ,String OBJECTNAME ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Universeobject> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Universeobject o = (Universeobject) it.next();
        ...
        results.close();
  	    this.original = this; 
        throw new SQLException(FactoryRes.CANNOT_GET_TABLE_DATA + "Universeobject");
      }
   ...
   * @exception SQLException
   */
  public Universeobject(RockFactory rockFact, Universeobject whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      Iterator<Universeobject> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        Universeobject o = (Universeobject) it.next();
                this.VERSIONID = o.getVersionid();
                this.CLASSNAME = o.getClassname();
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Universeobject whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Universeobject whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void saveDB() throws SQLException, RockException {
    ...
    if (this.newItem) {
      ...
      if (isPrimaryDefined()) {
        ...
        throw new RockException("Cannot use rock.Universeobject.saveDB(), no primary key defined");
      }
    }
    this.newItem = false;
  ...
  public String toSQLInsert(){
    ...
    StringBuffer sbuff = new StringBuffer();
    sbuff.append("insert into Universeobject ( ");
  ...
  public void removeNulls() {
     ...
     if (AGGREGATION == null)
      AGGREGATION = new String ("");
     if (OBJSELECT == null)
      OBJSELECT = new String ("");
     if (OBJWHERE == null)
      OBJWHERE = new String ("");
     if (PROMPTHIERARCHY == null)
      PROMPTHIERARCHY = new String ("");
     if (OBJ_BH_REL == null)
   ...
   public void setObjwhere(String OBJWHERE) {
    if (validateData){
   ...
   public void setPrompthierarchy(String PROMPTHIERARCHY) {
    if (validateData){
   ...
   public void setObj_bh_rel(Integer OBJ_BH_REL) {
    if (validateData){
   ...
   public void setElem_bh_rel(Integer ELEM_BH_REL) {
    if (validateData){
   ...
   public void setOrdernro(Long ORDERNRO) {
    if (validateData){
      DataValidator.validateData((Object)ORDERNRO,"ORDERNRO",2,126,38);
    }
  ...
  public boolean dbEquals(Universeobject o) {
  ...
  public boolean equals(Universeobject o) {
  ...
  */
  ...
  public Universeobject getOriginal() {
    return original;
  }
   
  public void setOriginal(Universeobject original) {
    this.original = (Universeobject) original.clone();
  }
