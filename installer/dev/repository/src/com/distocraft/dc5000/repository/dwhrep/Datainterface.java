...
public class Datainterface implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "INTERFACENAME"    ,"INTERFACEVERSION"   };
  ...
  public Datainterface(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Datainterface(RockFactory rockFact, boolean validate) {
   ...
   */
  public Datainterface(RockFactory rockFact   ,String INTERFACENAME ,String INTERFACEVERSION ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Datainterface> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Datainterface o = (Datainterface) it.next();
   ...
   * @exception SQLException
   */
  public Datainterface(RockFactory rockFact, Datainterface whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Datainterface whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Datainterface whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(Datainterface o) {
  ...
  public boolean equals(Datainterface o) {
  ...
  */
  ...
  public void setOriginal(Datainterface original) {
