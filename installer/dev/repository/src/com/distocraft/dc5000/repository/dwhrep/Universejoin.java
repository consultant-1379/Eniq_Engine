...
public class Universejoin implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "VERSIONID"    ,"SOURCETABLE"    ,"SOURCECOLUMN"    ,"TARGETTABLE"    ,"TARGETCOLUMN"    ,"TMPCOUNTER"   };
  ...
  public Universejoin(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Universejoin(RockFactory rockFact, boolean validate) {
   ...
   */
  public Universejoin(RockFactory rockFact   ,String VERSIONID ,String SOURCETABLE ,String SOURCECOLUMN ,String TARGETTABLE ,String TARGETCOLUMN ,Integer TMPCOUNTER ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Universejoin> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Universejoin o = (Universejoin) it.next();
   ...
   * @exception SQLException
   */
  public Universejoin(RockFactory rockFact, Universejoin whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Universejoin whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Universejoin whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
     ...
     if (SOURCETABLE == null)
      SOURCETABLE = new String ("");
     if (SOURCELEVEL == null)
      SOURCELEVEL = new String ("");
     if (SOURCECOLUMN == null)
      SOURCECOLUMN = new String ("");
     if (TARGETTABLE == null)
      TARGETTABLE = new String ("");
     if (TARGETLEVEL == null)
      TARGETLEVEL = new String ("");
     if (TARGETCOLUMN == null)
      TARGETCOLUMN = new String ("");
     if (EXPRESSION == null)
      EXPRESSION = new String ("");
     if (CARDINALITY == null)
      CARDINALITY = new String ("");
     if (CONTEXT == null)
      CONTEXT = new String ("");
     if (EXCLUDEDCONTEXTS == null)
      EXCLUDEDCONTEXTS = new String ("");
     if (TMPCOUNTER == null)
   ...
   public void setTmpcounter(Integer TMPCOUNTER) {
    if (validateData){
  ...
  public boolean dbEquals(Universejoin o) {
  ...
  public boolean equals(Universejoin o) {
  ...
  */
  ...
  public void setOriginal(Universejoin original) {
