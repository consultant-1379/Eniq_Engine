...
public class Universetable implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "VERSIONID"    ,"TABLENAME"    ,"UNIVERSEEXTENSION"   };
  ...
  public Universetable(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Universetable(RockFactory rockFact, boolean validate) {
   ...
   */
  public Universetable(RockFactory rockFact   ,String VERSIONID ,String TABLENAME ,String UNIVERSEEXTENSION ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Universetable> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Universetable o = (Universetable) it.next();
   ...
   * @exception SQLException
   */
  public Universetable(RockFactory rockFact, Universetable whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      Iterator<Universetable> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        Universetable o = (Universetable) it.next();
                this.VERSIONID = o.getVersionid();
                this.TABLENAME = o.getTablename();
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Universetable whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Universetable whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(Universetable o) {
  ...
  public boolean equals(Universetable o) {
  ...
  */
  ...
  public void setOriginal(Universetable original) {
