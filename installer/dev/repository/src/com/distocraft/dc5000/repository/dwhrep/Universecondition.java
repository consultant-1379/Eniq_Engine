...
public class Universecondition implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "VERSIONID"    ,"CLASSNAME"    ,"UNIVERSEEXTENSION"    ,"UNIVERSECONDITION"   };
  ...
  public Universecondition(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Universecondition(RockFactory rockFact, boolean validate) {
   ...
   */
  public Universecondition(RockFactory rockFact   ,String VERSIONID ,String CLASSNAME ,String UNIVERSEEXTENSION ,String UNIVERSECONDITION ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Universecondition> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Universecondition o = (Universecondition) it.next();
   ...
   * @exception SQLException
   */
  public Universecondition(RockFactory rockFact, Universecondition whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      Iterator<Universecondition> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        Universecondition o = (Universecondition) it.next();
                this.VERSIONID = o.getVersionid();
                this.CLASSNAME = o.getClassname();
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Universecondition whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Universecondition whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
     ...
     if (UNIVERSECONDITION == null)
      UNIVERSECONDITION = new String ("");
     if (DESCRIPTION == null)
      DESCRIPTION = new String ("");
     if (CONDWHERE == null)
      CONDWHERE = new String ("");
     if (AUTOGENERATE == null)
      AUTOGENERATE = new Integer (0);
     if (CONDOBJCLASS == null)
      CONDOBJCLASS = new String ("");
     if (CONDOBJECT == null)
      CONDOBJECT = new String ("");
     if (PROMPTTEXT == null)
   ...
   public void setUniversecondition(String UNIVERSECONDITION) {
    if (validateData){
   ...
   public void setCondobjclass(String CONDOBJCLASS) {
    if (validateData){
   ...
   public void setCondobject(String CONDOBJECT) {
    if (validateData){
  ...
  public boolean dbEquals(Universecondition o) {
  ...
  public boolean equals(Universecondition o) {
  ...
  */
  ...
  public void setOriginal(Universecondition original) {
