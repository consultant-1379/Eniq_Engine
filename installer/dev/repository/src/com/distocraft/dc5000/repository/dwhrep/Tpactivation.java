...
public class Tpactivation implements Cloneable,RockDBObject  {
  ...
  public Tpactivation(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Tpactivation(RockFactory rockFact, boolean validate) {
   ...
   */
  public Tpactivation(RockFactory rockFact   ,String TECHPACK_NAME ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Tpactivation> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Tpactivation o = (Tpactivation) it.next();
   ...
   * @exception SQLException
   */
  public Tpactivation(RockFactory rockFact, Tpactivation whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Tpactivation whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Tpactivation whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(Tpactivation o) {
  ...
  public boolean equals(Tpactivation o) {
  ...
  */
  ...
  public void setOriginal(Tpactivation original) {
