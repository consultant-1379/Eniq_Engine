...
public class Infomessages implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "MSGID"   };
  ...
  public Infomessages(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Infomessages(RockFactory rockFact, boolean validate) {
   ...
   */
  public Infomessages(RockFactory rockFact   ,Integer MSGID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Infomessages> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Infomessages o = (Infomessages) it.next();
   ...
   * @exception SQLException
   */
  public Infomessages(RockFactory rockFact, Infomessages whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Infomessages whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Infomessages whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(Infomessages o) {
  ...
  public boolean equals(Infomessages o) {
  ...
  */
  ...
  public void setOriginal(Infomessages original) {
