...
public class Universecomputedobject implements Cloneable,RockDBObject  {
  ...
  public Universecomputedobject(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Universecomputedobject(RockFactory rockFact, boolean validate) {
   ...
   */
  public Universecomputedobject(RockFactory rockFact   ,String VERSIONID ,String CLASSNAME ,String UNIVERSEEXTENSION ,String OBJECTNAME ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Universecomputedobject> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Universecomputedobject o = (Universecomputedobject) it.next();
   ...
   * @exception SQLException
   */
  public Universecomputedobject(RockFactory rockFact, Universecomputedobject whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Universecomputedobject whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Universecomputedobject whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(Universecomputedobject o) {
  ...
  public boolean equals(Universecomputedobject o) {
  ...
  */
  ...
  public void setOriginal(Universecomputedobject original) {
