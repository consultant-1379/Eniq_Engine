...
public class Dwhcolumn implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "STORAGEID"    ,"DATANAME"   };
  ...
  public Dwhcolumn(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Dwhcolumn(RockFactory rockFact, boolean validate) {
   ...
   */
  public Dwhcolumn(RockFactory rockFact   ,String STORAGEID ,String DATANAME ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Dwhcolumn> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Dwhcolumn o = (Dwhcolumn) it.next();
   ...
   * @exception SQLException
   */
  public Dwhcolumn(RockFactory rockFact, Dwhcolumn whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Dwhcolumn whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Dwhcolumn whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(Dwhcolumn o) {
  ...
  public boolean equals(Dwhcolumn o) {
  ...
  */
  ...
  public void setOriginal(Dwhcolumn original) {
