...
public class Interfacedependency implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "INTERFACEVERSION"    ,"INTERFACENAME"    ,"TECHPACKNAME"    ,"TECHPACKVERSION"   };
  ...
  public Interfacedependency(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Interfacedependency(RockFactory rockFact, boolean validate) {
   ...
   */
  public Interfacedependency(RockFactory rockFact   ,String INTERFACEVERSION ,String INTERFACENAME ,String TECHPACKNAME ,String TECHPACKVERSION ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Interfacedependency> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Interfacedependency o = (Interfacedependency) it.next();
   ...
   * @exception SQLException
   */
  public Interfacedependency(RockFactory rockFact, Interfacedependency whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Interfacedependency whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Interfacedependency whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(Interfacedependency o) {
  ...
  public boolean equals(Interfacedependency o) {
  ...
  */
  ...
  public void setOriginal(Interfacedependency original) {
