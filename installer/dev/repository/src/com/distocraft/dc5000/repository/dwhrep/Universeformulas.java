...
public class Universeformulas implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "VERSIONID"    ,"NAME"   };
  ...
  public Universeformulas(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Universeformulas(RockFactory rockFact, boolean validate) {
   ...
   */
  public Universeformulas(RockFactory rockFact   ,String VERSIONID ,String NAME ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Universeformulas> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Universeformulas o = (Universeformulas) it.next();
   ...
   * @exception SQLException
   */
  public Universeformulas(RockFactory rockFact, Universeformulas whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Universeformulas whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Universeformulas whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(Universeformulas o) {
  ...
  public boolean equals(Universeformulas o) {
  ...
  */
  ...
  public void setOriginal(Universeformulas original) {
