...
public class Alarmreportparameter implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "REPORTID"    ,"NAME"   };
  ...
  public Alarmreportparameter(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Alarmreportparameter(RockFactory rockFact, boolean validate) {
   ...
   */
  public Alarmreportparameter(RockFactory rockFact   ,String REPORTID ,String NAME ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Alarmreportparameter> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Alarmreportparameter o = (Alarmreportparameter) it.next();
   ...
   * @exception SQLException
   */
  public Alarmreportparameter(RockFactory rockFact, Alarmreportparameter whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Alarmreportparameter whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Alarmreportparameter whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(Alarmreportparameter o) {
  ...
  public boolean equals(Alarmreportparameter o) {
  ...
  */
  ...
  public void setOriginal(Alarmreportparameter original) {
