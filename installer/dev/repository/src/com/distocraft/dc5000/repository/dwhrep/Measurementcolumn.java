...
public class Measurementcolumn implements Cloneable,RockDBObject  {
   ...
   */
  public Measurementcolumn(RockFactory rockFact, boolean validate) {
   ...
   */
  public Measurementcolumn(RockFactory rockFact   ,String MTABLEID ,String DATANAME ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Measurementcolumn> it = rockFact.getData(this, results);
      if (it.hasNext()) {
   ...
   * @exception SQLException
   */
  public Measurementcolumn(RockFactory rockFact, Measurementcolumn whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
  ...
  public boolean dbEquals(Measurementcolumn o) {
  ...
  */
  ...
  public void setOriginal(Measurementcolumn original) {
