...
public class Dataitem implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "DATAFORMATID"    ,"DATANAME"   };
  ...
  public Dataitem(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Dataitem(RockFactory rockFact, boolean validate) {
   ...
   */
  public Dataitem(RockFactory rockFact   ,String DATAFORMATID ,String DATANAME ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Dataitem> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Dataitem o = (Dataitem) it.next();
   ...
   * @exception SQLException
   */
  public Dataitem(RockFactory rockFact, Dataitem whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Dataitem whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Dataitem whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
     ...
     if (PROCESS_INSTRUCTION == null)
      PROCESS_INSTRUCTION = new String ("");
     if (DATATYPE == null)
      DATATYPE = new String ("");
     if (DATASIZE == null)
   ...
   public void setProcess_instruction(String PROCESS_INSTRUCTION) {
    if (validateData){
  ...
  public boolean dbEquals(Dataitem o) {
  ...
  */
  ...
  public void setOriginal(Dataitem original) {
