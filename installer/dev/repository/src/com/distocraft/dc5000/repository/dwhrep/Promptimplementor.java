...
public class Promptimplementor implements Cloneable,RockDBObject  {

    private String VERSIONID;
    private Integer PROMPTIMPLEMENTORID;
    private String PROMPTCLASSNAME;
  ...
  private String[] primaryKeyNames = {    "VERSIONID"    ,"PROMPTIMPLEMENTORID"   };
  ...
  private Promptimplementor original; 

  public Promptimplementor(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Promptimplementor(RockFactory rockFact, boolean validate) {
   ...
   */
  public Promptimplementor(RockFactory rockFact   ,String VERSIONID ,Integer PROMPTIMPLEMENTORID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Promptimplementor> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Promptimplementor o = (Promptimplementor) it.next();

              this.VERSIONID = o.getVersionid();
              this.PROMPTIMPLEMENTORID = o.getPromptimplementorid();
              this.PROMPTCLASSNAME = o.getPromptclassname();
        ...
        results.close();
  	    this.original = this; 
        throw new SQLException(FactoryRes.CANNOT_GET_TABLE_DATA + "Promptimplementor");
      }
   ...
   * @exception SQLException
   */
  public Promptimplementor(RockFactory rockFact, Promptimplementor whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      Iterator<Promptimplementor> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        Promptimplementor o = (Promptimplementor) it.next();
                this.VERSIONID = o.getVersionid();
                this.PROMPTIMPLEMENTORID = o.getPromptimplementorid();
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Promptimplementor whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Promptimplementor whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void saveDB() throws SQLException, RockException {
    ...
    if (this.newItem) {
      ...
      if (isPrimaryDefined()) {
        ...
        throw new RockException("Cannot use rock.Promptimplementor.saveDB(), no primary key defined");
      }
    }
    this.newItem = false;
   ...
   */
    ...
    sbuff.append("<Promptimplementor ");
        ...
        sbuff.append("PROMPTCLASSNAME=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.PROMPTCLASSNAME),12, true)+"\" ");
        sbuff.append("PRIORITY=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.PRIORITY),4, true)+"\" ");
  ...
  public String toSQLInsert(){
    ...
    StringBuffer sbuff = new StringBuffer();
    sbuff.append("insert into Promptimplementor ( ");
	    		sbuff.append("VERSIONID");
		    		sbuff.append(", PROMPTIMPLEMENTORID");
	    		sbuff.append(", PROMPTCLASSNAME");
	        ...
	        sbuff.append(" ) values ( ");
    	        ...
    	        sbuff.append(", "+DataValidator.wrap(""+this.PROMPTCLASSNAME,12)+"");
    	        sbuff.append(", "+DataValidator.wrap(""+this.PRIORITY,4)+"");
    	    sbuff.append(" );\n");   
    return sbuff.toString();
  }
  ...
  public void removeNulls() {
     ...
     if (PROMPTCLASSNAME == null)
      PROMPTCLASSNAME = new String ("");
     if (PRIORITY == null)
   ...
   public void setPromptclassname(String PROMPTCLASSNAME) {
    if (validateData){
      DataValidator.validateData((Object)PROMPTCLASSNAME,"PROMPTCLASSNAME",12,255,0);
    }
    modifiedColumns.add("PROMPTCLASSNAME");
    this.PROMPTCLASSNAME = PROMPTCLASSNAME;
  }
   public void setPriority(Integer PRIORITY) {
    if (validateData){
      DataValidator.validateData((Object)PRIORITY,"PRIORITY",4,10,0);
    }
  ...
  public boolean dbEquals(Promptimplementor o) {
  ...
  public boolean equals(Promptimplementor o) {

         if ((((this.VERSIONID == null) || (o.VERSIONID == null)) && (this.VERSIONID != o.VERSIONID))
            || (((this.PROMPTIMPLEMENTORID == null) || (o.PROMPTIMPLEMENTORID == null)) && (this.PROMPTIMPLEMENTORID != o.PROMPTIMPLEMENTORID))
            || (((this.PROMPTCLASSNAME == null) || (o.PROMPTCLASSNAME == null)) && (this.PROMPTCLASSNAME != o.PROMPTCLASSNAME))
    ...
    return false;
         ...
         if ((((this.VERSIONID != null) && (o.VERSIONID != null)) && (this.VERSIONID.equals(o.VERSIONID) == false))
            || (((this.PROMPTIMPLEMENTORID != null) && (o.PROMPTIMPLEMENTORID != null)) && (this.PROMPTIMPLEMENTORID.equals(o.PROMPTIMPLEMENTORID) == false))
            || (((this.PROMPTCLASSNAME != null) && (o.PROMPTCLASSNAME != null)) && (this.PROMPTCLASSNAME.equals(o.PROMPTCLASSNAME) == false))
  ...
  * return 255
  */
  public static int getPromptclassnameColumnSize() {
  ...
  * return 0
  */
  public static int getPromptclassnameDecimalDigits() {
  ...
  * return 12
  */
  public static int getPromptclassnameSQLType() {
  ...
  */
  ...
  public Promptimplementor getOriginal() {
    return original;
  }
   
  public void setOriginal(Promptimplementor original) {
    this.original = (Promptimplementor) original.clone();
  }
