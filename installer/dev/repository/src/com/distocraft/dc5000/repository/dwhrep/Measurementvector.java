...
public class Measurementvector implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "TYPEID"    ,"DATANAME"    ,"VENDORRELEASE"    ,"VINDEX"   };
  ...
  public Measurementvector(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Measurementvector(RockFactory rockFact, boolean validate) {
   ...
   */
  public Measurementvector(RockFactory rockFact   ,String TYPEID ,String DATANAME ,String VENDORRELEASE ,Long VINDEX ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Measurementvector> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Measurementvector o = (Measurementvector) it.next();
   ...
   * @exception SQLException
   */
  public Measurementvector(RockFactory rockFact, Measurementvector whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Measurementvector whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Measurementvector whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
   ...
   public void setVindex(Long VINDEX) {
    if (validateData){
      DataValidator.validateData((Object)VINDEX,"VINDEX",2,126,38);
    }
   ...
   public void setQuantity(Long QUANTITY) {
    if (validateData){
      DataValidator.validateData((Object)QUANTITY,"QUANTITY",2,126,38);
    }
  ...
  public boolean dbEquals(Measurementvector o) {
  ...
  public boolean equals(Measurementvector o) {
  ...
  */
  ...
  public void setOriginal(Measurementvector original) {
