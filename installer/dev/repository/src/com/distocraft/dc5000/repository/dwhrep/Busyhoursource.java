...
public class Busyhoursource implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "VERSIONID"    ,"BHLEVEL"    ,"BHTYPE"    ,"TYPENAME"    ,"TARGETVERSIONID"    ,"BHOBJECT"   };
  ...
  private Busyhoursource original; 

  public Busyhoursource(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Busyhoursource(RockFactory rockFact, boolean validate) {
   ...
   */
  public Busyhoursource(RockFactory rockFact   ,String VERSIONID ,String BHLEVEL ,String BHTYPE ,String TYPENAME ,String TARGETVERSIONID ,String BHOBJECT ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Busyhoursource> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Busyhoursource o = (Busyhoursource) it.next();
        ...
        results.close();
  	    this.original = this; 
        throw new SQLException(FactoryRes.CANNOT_GET_TABLE_DATA + "Busyhoursource");
      }
   ...
   * @exception SQLException
   */
  public Busyhoursource(RockFactory rockFact, Busyhoursource whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Busyhoursource whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Busyhoursource whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void saveDB() throws SQLException, RockException {
    ...
    if (this.newItem) {
      ...
      if (isPrimaryDefined()) {
        ...
        throw new RockException("Cannot use rock.Busyhoursource.saveDB(), no primary key defined");
      }
    }
    this.newItem = false;
  ...
  public String toSQLInsert(){
    ...
    StringBuffer sbuff = new StringBuffer();
    sbuff.append("insert into Busyhoursource ( ");
  ...
  public boolean dbEquals(Busyhoursource o) {
  ...
  public boolean equals(Busyhoursource o) {
  ...
  */
  ...
  public Busyhoursource getOriginal() {
    return original;
  }
   
  public void setOriginal(Busyhoursource original) {
    this.original = (Busyhoursource) original.clone();
  }
