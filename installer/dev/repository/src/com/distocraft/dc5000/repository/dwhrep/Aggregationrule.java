...
public class Aggregationrule implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "AGGREGATION"    ,"VERSIONID"    ,"RULEID"    ,"RULETYPE"   };
  ...
  public Aggregationrule(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Aggregationrule(RockFactory rockFact, boolean validate) {
   ...
   */
  public Aggregationrule(RockFactory rockFact   ,String AGGREGATION ,String VERSIONID ,Integer RULEID ,String RULETYPE ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Aggregationrule> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Aggregationrule o = (Aggregationrule) it.next();
   ...
   * @exception SQLException
   */
  public Aggregationrule(RockFactory rockFact, Aggregationrule whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Aggregationrule whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Aggregationrule whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
     ...
     if (TARGET_TYPE == null)
      TARGET_TYPE = new String ("");
     if (TARGET_LEVEL == null)
      TARGET_LEVEL = new String ("");
     if (TARGET_TABLE == null)
      TARGET_TABLE = new String ("");
     if (TARGET_MTABLEID == null)
      TARGET_MTABLEID = new String ("");
     if (SOURCE_TYPE == null)
      SOURCE_TYPE = new String ("");
     if (SOURCE_LEVEL == null)
      SOURCE_LEVEL = new String ("");
     if (SOURCE_TABLE == null)
      SOURCE_TABLE = new String ("");
     if (SOURCE_MTABLEID == null)
      SOURCE_MTABLEID = new String ("");
     if (RULETYPE == null)
      RULETYPE = new String ("");
     if (AGGREGATIONSCOPE == null)
      AGGREGATIONSCOPE = new String ("");
     if (BHTYPE == null)
      BHTYPE = new String ("");
     if (ENABLE == null)
   ...
   public void setTarget_mtableid(String TARGET_MTABLEID) {
    if (validateData){
   ...
   public void setSource_mtableid(String SOURCE_MTABLEID) {
    if (validateData){
  ...
  public boolean dbEquals(Aggregationrule o) {
  ...
  public boolean equals(Aggregationrule o) {
  ...
  */
  ...
  public void setOriginal(Aggregationrule original) {
