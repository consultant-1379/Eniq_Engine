...
public class Measurementtable implements Cloneable,RockDBObject  {
   ...
   */
  public Measurementtable(RockFactory rockFact, boolean validate) {
   ...
   */
  public Measurementtable(RockFactory rockFact   ,String MTABLEID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Measurementtable> it = rockFact.getData(this, results);
      if (it.hasNext()) {
   ...
   * @exception SQLException
   */
  public Measurementtable(RockFactory rockFact, Measurementtable whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
  ...
  public boolean dbEquals(Measurementtable o) {
  ...
  */
  ...
  public void setOriginal(Measurementtable original) {
