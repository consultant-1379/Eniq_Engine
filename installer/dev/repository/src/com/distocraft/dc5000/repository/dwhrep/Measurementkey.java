...
public class Measurementkey implements Cloneable,RockDBObject  {
   ...
   */
  public Measurementkey(RockFactory rockFact, boolean validate) {
   ...
   */
  public Measurementkey(RockFactory rockFact   ,String TYPEID ,String DATANAME ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Measurementkey> it = rockFact.getData(this, results);
      if (it.hasNext()) {
   ...
   * @exception SQLException
   */
  public Measurementkey(RockFactory rockFact, Measurementkey whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
  ...
  public void removeNulls() {
   ...
   public void setJoinable(Integer JOINABLE) {
    if (validateData){
  ...
  public boolean dbEquals(Measurementkey o) {
  ...
  */
  ...
  public void setOriginal(Measurementkey original) {
