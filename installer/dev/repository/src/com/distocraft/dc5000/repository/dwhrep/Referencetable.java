...
public class Referencetable implements Cloneable,RockDBObject  {
  ...
  public Referencetable(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Referencetable(RockFactory rockFact, boolean validate) {
   ...
   */
  public Referencetable(RockFactory rockFact   ,String TYPEID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Referencetable> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Referencetable o = (Referencetable) it.next();
   ...
   * @exception SQLException
   */
  public Referencetable(RockFactory rockFact, Referencetable whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Referencetable whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Referencetable whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
   ...
   public void setUpdate_policy(Long UPDATE_POLICY) {
    if (validateData){
  ...
  public boolean dbEquals(Referencetable o) {
  ...
  public boolean equals(Referencetable o) {
  ...
  */
  ...
  public void setOriginal(Referencetable original) {
