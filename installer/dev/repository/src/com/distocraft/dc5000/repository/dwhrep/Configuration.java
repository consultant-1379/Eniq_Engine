...
public class Configuration implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "PARAMNAME"   };
  ...
  public Configuration(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Configuration(RockFactory rockFact, boolean validate) {
   ...
   */
  public Configuration(RockFactory rockFact   ,String PARAMNAME ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Configuration> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Configuration o = (Configuration) it.next();
   ...
   * @exception SQLException
   */
  public Configuration(RockFactory rockFact, Configuration whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Configuration whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Configuration whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(Configuration o) {
  ...
  public boolean equals(Configuration o) {
