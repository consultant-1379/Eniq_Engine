...
public class Universename implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "VERSIONID"    ,"UNIVERSEEXTENSION"   };
  ...
  public Universename(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Universename(RockFactory rockFact, boolean validate) {
   ...
   */
  public Universename(RockFactory rockFact   ,String VERSIONID ,String UNIVERSEEXTENSION ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Universename> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Universename o = (Universename) it.next();
   ...
   * @exception SQLException
   */
  public Universename(RockFactory rockFact, Universename whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Universename whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Universename whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
   ...
   public void setUniverseextensionname(String UNIVERSEEXTENSIONNAME) {
    if (validateData){
  ...
  public boolean dbEquals(Universename o) {
  ...
  public boolean equals(Universename o) {
  ...
  */
  ...
  public void setOriginal(Universename original) {
