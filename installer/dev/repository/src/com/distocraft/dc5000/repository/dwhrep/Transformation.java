...
public class Transformation implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "TRANSFORMERID"    ,"ORDERNO"   };
  ...
  public Transformation(RockFactory rockFact) {
    this(rockFact, false);
    original = null; 
  }
   ...
   */
  public Transformation(RockFactory rockFact, boolean validate) {
   ...
   */
  public Transformation(RockFactory rockFact   ,String TRANSFORMERID ,Long ORDERNO ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Transformation> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Transformation o = (Transformation) it.next();
   ...
   * @exception SQLException
   */
  public Transformation(RockFactory rockFact, Transformation whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Transformation whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Transformation whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(Transformation o) {
  ...
  public boolean equals(Transformation o) {
...
//  }
  ...
  */
  ...
  public void setOriginal(Transformation original) {
