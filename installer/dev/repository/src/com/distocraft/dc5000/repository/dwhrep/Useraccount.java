...
public class Useraccount implements Cloneable,RockDBObject  {
  ...
  private String[] primaryKeyNames = {    "NAME"   };
  ...
  public Useraccount(RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Useraccount(RockFactory rockFact, boolean validate) {
   ...
   */
  public Useraccount(RockFactory rockFact   ,String NAME ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      Iterator<Useraccount> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        Useraccount o = (Useraccount) it.next();
   ...
   * @exception SQLException
   */
  public Useraccount(RockFactory rockFact, Useraccount whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
   ...
   * @exception SQLException
   */
  public int updateDB(boolean useTimestamp, Useraccount whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(Useraccount whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(Useraccount o) {
  ...
  */
  ...
  public void setOriginal(Useraccount original) {
