...
public class ModuleFactory implements Cloneable {
  ...
  private Module whereObject;

  public ModuleFactory(RockFactory rockFact, Module whereObject) throws SQLException,
      RockException {
  ...
  public ModuleFactory(RockFactory rockFact, Module whereObject, String orderByClause)
  ...
  public Module getElementAt(int i) {
    if (i < this.vec.size()) {
      return (Module) this.vec.elementAt(i);
    }
    return (Module) null;
  }
  ...
  public boolean equals(Vector otherVector) {
    ...
    for (int i = 0; i < this.vec.size(); i++) {
      ModuleFactory o = (ModuleFactory) this.vec.elementAt(i);
      ModuleFactory otherO = (ModuleFactory) otherVector.elementAt(i);
