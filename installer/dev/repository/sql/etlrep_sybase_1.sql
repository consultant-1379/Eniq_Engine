...
INSERT INTO META_DATABASES VALUES ('etlrep','0','USER','0','etlrep','jdbc:sybase:Tds:repdb:@rep.port@?SQLINITSTRING=SET TEMPORARY OPTION CONNECTION_AUTHENTICATION=''Company=Ericsson;Application=ENIQ;Signature=000fa55157edb8e14d818eb4fe3db41447146f1571g539f0a8f80fd6239ea117b9d74be36c19c58dc14''','@etlrep.password@','ETL Repository Database','com.sybase.jdbc3.jdbc.SybDriver',null);

INSERT INTO META_DATABASES VALUES ('dwhrep','0','USER','1','dwhrep','jdbc:sybase:Tds:repdb:@rep.port@?SQLINITSTRING=SET TEMPORARY OPTION CONNECTION_AUTHENTICATION=''Company=Ericsson;Application=ENIQ;Signature=000fa55157edb8e14d818eb4fe3db41447146f1571g539f0a8f80fd6239ea117b9d74be36c19c58dc14''','@dwhrep.password@','DWH Repository Database','com.sybase.jdbc3.jdbc.SybDriver',null);

INSERT INTO META_DATABASES VALUES ('dc','0','USER','2','dwh','jdbc:sybase:Tds:dwhdb:@dwh.port@','@dwh.password@','The DataWareHouse Database','com.sybase.jdbc3.jdbc.SybDriver',null);

INSERT INTO META_DATABASES VALUES ('dba','0','DBA','3','etlrep','jdbc:sybase:Tds:repdb:@rep.port@?SQLINITSTRING=SET TEMPORARY OPTION CONNECTION_AUTHENTICATION=''Company=Ericsson;Application=ENIQ;Signature=000fa55157edb8e14d818eb4fe3db41447146f1571g539f0a8f80fd6239ea117b9d74be36c19c58dc14''','@dba.password@','ETL Repository Database','com.sybase.jdbc3.jdbc.SybDriver',null);

INSERT INTO META_DATABASES VALUES ('dba','0','DBA','4','dwhrep','jdbc:sybase:Tds:repdb:@rep.port@?SQLINITSTRING=SET TEMPORARY OPTION CONNECTION_AUTHENTICATION=''Company=Ericsson;Application=ENIQ;Signature=000fa55157edb8e14d818eb4fe3db41447146f1571g539f0a8f80fd6239ea117b9d74be36c19c58dc14''','@dba.password@','DWH Repository Database','com.sybase.jdbc3.jdbc.SybDriver',null);

INSERT INTO META_DATABASES VALUES ('dba','0','DBA','5','dwh','jdbc:sybase:Tds:dwhdb:@dwh.port@','@dba.password@','The DataWareHouse Database','com.sybase.jdbc3.jdbc.SybDriver',null);
