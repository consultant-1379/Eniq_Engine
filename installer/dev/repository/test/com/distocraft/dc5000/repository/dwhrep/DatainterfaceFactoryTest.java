...
public class DatainterfaceFactoryTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    stmt.execute("CREATE TABLE Datainterface ( INTERFACENAME VARCHAR(31)  ,STATUS BIGINT  ,INTERFACETYPE VARCHAR(31) ,DESCRIPTION VARCHAR(31) ,DATAFORMATTYPE VARCHAR(31) ,INTERFACEVERSION VARCHAR(31) ,LOCKEDBY VARCHAR(31) ,LOCKDATE TIMESTAMP  ,PRODUCTNUMBER VARCHAR(31) ,ENIQ_LEVEL VARCHAR(31) ,RSTATE VARCHAR(31))");
  ...
  public void setUp() throws Exception {
    ...
    /* Adding example data to table */
	  stmt.executeUpdate("INSERT INTO Datainterface VALUES( 'testINTERFACENAME3'  ,3  ,'testINTERFACETYPE3'  ,'testDESCRIPTION3'  ,'testDATAFORMATTYPE3'  ,'testINTERFACEVERSION3'  ,'testLOCKEDBY3'  ,'2003-03-03 00:00:00.0'  ,'testPRODUCTNUMBER3'  ,'testENIQ_LEVEL3'  ,'testRSTATE3' )");
	  stmt.executeUpdate("INSERT INTO Datainterface VALUES( 'testINTERFACENAME2'  ,2  ,'testINTERFACETYPE2'  ,'testDESCRIPTION2'  ,'testDATAFORMATTYPE2'  ,'testINTERFACEVERSION2'  ,'testLOCKEDBY2'  ,'2002-02-02 00:00:00.0'  ,'testPRODUCTNUMBER2'  ,'testENIQ_LEVEL2'  ,'testRSTATE2' )");
	  stmt.executeUpdate("INSERT INTO Datainterface VALUES( 'testINTERFACENAME1'  ,1  ,'testINTERFACETYPE1'  ,'testDESCRIPTION1'  ,'testDATAFORMATTYPE1'  ,'testINTERFACEVERSION1'  ,'testLOCKEDBY1'  ,'2001-01-01 00:00:00.0'  ,'testPRODUCTNUMBER1'  ,'testENIQ_LEVEL1'  ,'testRSTATE1' )");
