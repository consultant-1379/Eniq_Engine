...
public class MeasurementtypeFactoryTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    stmt.execute("CREATE TABLE Measurementtype ( TYPEID VARCHAR(31)  ,TYPECLASSID VARCHAR(31) ,TYPENAME VARCHAR(31) ,VENDORID VARCHAR(31) ,FOLDERNAME VARCHAR(31) ,DESCRIPTION VARCHAR(31) ,STATUS BIGINT  ,VERSIONID VARCHAR(31) ,OBJECTID VARCHAR(31) ,OBJECTNAME VARCHAR(31) ,OBJECTVERSION INTEGER  ,OBJECTTYPE VARCHAR(31) ,JOINABLE VARCHAR(31) ,SIZING VARCHAR(31) ,TOTALAGG INTEGER  ,ELEMENTBHSUPPORT INTEGER  ,RANKINGTABLE INTEGER  ,DELTACALCSUPPORT INTEGER  ,PLAINTABLE INTEGER  ,UNIVERSEEXTENSION VARCHAR(31) ,VECTORSUPPORT INTEGER  ,DATAFORMATSUPPORT INTEGER  ,FOLLOWJOHN INTEGER )");
  ...
  public void setUp() throws Exception {
    ...
    /* Adding example data to table */
	  stmt.executeUpdate("INSERT INTO Measurementtype VALUES( 'testTYPEID3'  ,'testTYPECLASSID3'  ,'testTYPENAME3'  ,'testVENDORID3'  ,'testFOLDERNAME3'  ,'testDESCRIPTION3'  ,3  ,'testVERSIONID3'  ,'testOBJECTID3'  ,'testOBJECTNAME3'  ,3  ,'testOBJECTTYPE3'  ,'testJOINABLE3'  ,'testSIZING3'  ,3  ,3  ,3  ,3  ,3  ,'testUNIVERSEEXTENSION3'  ,3  ,3  ,3 )");
	  stmt.executeUpdate("INSERT INTO Measurementtype VALUES( 'testTYPEID2'  ,'testTYPECLASSID2'  ,'testTYPENAME2'  ,'testVENDORID2'  ,'testFOLDERNAME2'  ,'testDESCRIPTION2'  ,2  ,'testVERSIONID2'  ,'testOBJECTID2'  ,'testOBJECTNAME2'  ,2  ,'testOBJECTTYPE2'  ,'testJOINABLE2'  ,'testSIZING2'  ,2  ,2  ,2  ,2  ,2  ,'testUNIVERSEEXTENSION2'  ,2  ,2  ,2 )");
	  stmt.executeUpdate("INSERT INTO Measurementtype VALUES( 'testTYPEID1'  ,'testTYPECLASSID1'  ,'testTYPENAME1'  ,'testVENDORID1'  ,'testFOLDERNAME1'  ,'testDESCRIPTION1'  ,1  ,'testVERSIONID1'  ,'testOBJECTID1'  ,'testOBJECTNAME1'  ,1  ,'testOBJECTTYPE1'  ,'testJOINABLE1'  ,'testSIZING1'  ,1  ,1  ,1  ,1  ,1  ,'testUNIVERSEEXTENSION1'  ,1  ,1  ,1 )");
