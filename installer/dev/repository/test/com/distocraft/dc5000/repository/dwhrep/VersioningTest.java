...
public class VersioningTest {
  ...
  public void testSetAndGetLicensename() throws Exception {
    ...
    /* Setting column values and asserting correct value is returned */
    objUnderTest.setLicensename(VersioningTest.testStringGenerator("anotherLICENSENAME", 255));
    assertEquals(VersioningTest.testStringGenerator("anotherLICENSENAME", 255), LICENSENAME.get(objUnderTest));
  }
  ...
  */
  ...
  public void testGetLicensenameColumnSize() throws Exception {
     ...
     assertEquals(255, objUnderTest.getLicensenameColumnSize());   
  }
