...
public class DatainterfaceTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    stmt.execute("CREATE TABLE Datainterface ( INTERFACENAME VARCHAR(255)  ,STATUS BIGINT  ,INTERFACETYPE VARCHAR(31) ,DESCRIPTION VARCHAR(31) ,DATAFORMATTYPE VARCHAR(31) ,INTERFACEVERSION VARCHAR(31) ,LOCKEDBY VARCHAR(31) ,LOCKDATE TIMESTAMP  ,PRODUCTNUMBER VARCHAR(31) ,ENIQ_LEVEL VARCHAR(31) ,RSTATE VARCHAR(31))");
  ...
  public void setUp() throws Exception {
    ...
    stmt.executeUpdate("INSERT INTO Datainterface VALUES( 'testINTERFACENAME'  ,1  ,'testINTERFACETYPE'  ,'testDESCRIPTION'  ,'testDATAFORMATTYPE'  ,'testINTERFACEVERSION'  ,'testLOCKEDBY'  ,'2000-01-01 00:00:00.0'  ,'testPRODUCTNUMBER'  ,'testENIQ_LEVEL'  ,'testRSTATE' )");
  ...
  public void testDatainterfaceConstructorWithPrimaryKeyDefined() throws Exception {
    ...
    String actual =  INTERFACENAME.get(objUnderTest)  + ", " + STATUS.get(objUnderTest)  + ", " + INTERFACETYPE.get(objUnderTest)  + ", " + DESCRIPTION.get(objUnderTest)  + ", " + DATAFORMATTYPE.get(objUnderTest)  + ", " + INTERFACEVERSION.get(objUnderTest)  + ", " + LOCKEDBY.get(objUnderTest)  + ", " + LOCKDATE.get(objUnderTest)  + ", " + PRODUCTNUMBER.get(objUnderTest)  + ", " + ENIQ_LEVEL.get(objUnderTest)  + ", " + RSTATE.get(objUnderTest) ;
    String expected =  "testINTERFACENAME"  + ", 1"  + ", testINTERFACETYPE"  + ", testDESCRIPTION"  + ", testDATAFORMATTYPE"  + ", testINTERFACEVERSION"  + ", testLOCKEDBY"  + ", 2000-01-01 00:00:00.0"  + ", testPRODUCTNUMBER"  + ", testENIQ_LEVEL"  + ", testRSTATE" ;
    assertEquals(expected, actual);
  }
  ...
  public void testToXML_tag() throws Exception {
    ...
    String expected = "<Datainterface INTERFACENAME=\"'testINTERFACENAME'\" STATUS=\"1\" INTERFACETYPE=\"'testINTERFACETYPE'\" DESCRIPTION=\"'testDESCRIPTION'\" DATAFORMATTYPE=\"'testDATAFORMATTYPE'\" INTERFACEVERSION=\"'testINTERFACEVERSION'\" LOCKEDBY=\"'testLOCKEDBY'\" LOCKDATE=\"'2000-01-01 00:00:00.0'\" PRODUCTNUMBER=\"'testPRODUCTNUMBER'\" ENIQ_LEVEL=\"'testENIQ_LEVEL'\" RSTATE=\"'testRSTATE'\" DiffStatus=\"\" />\n";
  ...
  public void testToSQLInsert() throws Exception {
    ...
    String expected = "insert into Datainterface ( INTERFACENAME, STATUS, INTERFACETYPE, DESCRIPTION, DATAFORMATTYPE, INTERFACEVERSION, LOCKEDBY, LOCKDATE, PRODUCTNUMBER, ENIQ_LEVEL, RSTATE ) values "
      + "( 'testINTERFACENAME', 1, 'testINTERFACETYPE', 'testDESCRIPTION', 'testDATAFORMATTYPE', 'testINTERFACEVERSION', 'testLOCKEDBY', '2000-01-01 00:00:00.0', 'testPRODUCTNUMBER', 'testENIQ_LEVEL', 'testRSTATE' );\n";
