...
public class InterfacedependencyTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    stmt.execute("CREATE TABLE Interfacedependency ( INTERFACEVERSION VARCHAR(31)  ,INTERFACENAME VARCHAR(255) ,TECHPACKNAME VARCHAR(31) ,TECHPACKVERSION VARCHAR(31))");
