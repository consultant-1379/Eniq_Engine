...
public class DataformatTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    stmt.execute("CREATE TABLE Dataformat ( DATAFORMATID VARCHAR(31)  ,TYPEID VARCHAR(31) ,VERSIONID VARCHAR(31) ,OBJECTTYPE VARCHAR(31) ,FOLDERNAME VARCHAR(128) ,DATAFORMATTYPE VARCHAR(31))");
