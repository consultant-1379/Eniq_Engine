...
public class InterfacetechpacksTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    stmt.execute("CREATE TABLE Interfacetechpacks ( INTERFACENAME VARCHAR(31)  ,TECHPACKNAME VARCHAR(255) ,TECHPACKVERSION VARCHAR(31) ,INTERFACEVERSION VARCHAR(31))");
  ...
  public void testSetAndGetInterfacename() throws Exception {
    ...
    objUnderTest.setInterfacename(InterfacetechpacksTest.testStringGenerator("anotherINTERFACENAME", 50));
    assertEquals(InterfacetechpacksTest.testStringGenerator("anotherINTERFACENAME", 50), INTERFACENAME.get(objUnderTest));
  }
    /**
   * Testing column data setting and retrieving via get and set methods.
   */
  ...
  public void testSetAndGetTechpackname() throws Exception {
    ...
    /* Setting column values and asserting correct value is returned */
    objUnderTest.setTechpackname(InterfacetechpacksTest.testStringGenerator("anotherTECHPACKNAME", 255));
    assertEquals(InterfacetechpacksTest.testStringGenerator("anotherTECHPACKNAME", 255), TECHPACKNAME.get(objUnderTest));
  }
    /**
   * Testing column data setting and retrieving via get and set methods.
   */
