...
public class MeasurementtypeTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    stmt.execute("CREATE TABLE Measurementtype ( TYPEID VARCHAR(31)  ,TYPECLASSID VARCHAR(255) ,TYPENAME VARCHAR(31) ,VENDORID VARCHAR(128) ,FOLDERNAME VARCHAR(128) ,DESCRIPTION VARCHAR(31) ,STATUS BIGINT  ,VERSIONID VARCHAR(31) ,OBJECTID VARCHAR(31) ,OBJECTNAME VARCHAR(31) ,OBJECTVERSION INTEGER  ,OBJECTTYPE VARCHAR(31) ,JOINABLE VARCHAR(31) ,SIZING VARCHAR(31) ,TOTALAGG INTEGER  ,ELEMENTBHSUPPORT INTEGER  ,RANKINGTABLE INTEGER  ,DELTACALCSUPPORT INTEGER  ,PLAINTABLE INTEGER  ,UNIVERSEEXTENSION VARCHAR(31) ,VECTORSUPPORT INTEGER  ,DATAFORMATSUPPORT INTEGER  ,FOLLOWJOHN INTEGER )");
  ...
  public void setUp() throws Exception {
    ...
    stmt.executeUpdate("INSERT INTO Measurementtype VALUES( 'testTYPEID'  ,'testTYPECLASSID'  ,'testTYPENAME'  ,'testVENDORID'  ,'testFOLDERNAME'  ,'testDESCRIPTION'  ,1  ,'testVERSIONID'  ,'testOBJECTID'  ,'testOBJECTNAME'  ,1  ,'testOBJECTTYPE'  ,'testJOINABLE'  ,'testSIZING'  ,1  ,1  ,1  ,1  ,1  ,'testUNIVERSEEXTENSION'  ,1  ,1  ,1 )");
  ...
  public void testMeasurementtypeConstructorWithPrimaryKeyDefined() throws Exception {
    ...
    String actual =  TYPEID.get(objUnderTest)  + ", " + TYPECLASSID.get(objUnderTest)  + ", " + TYPENAME.get(objUnderTest)  + ", " + VENDORID.get(objUnderTest)  + ", " + FOLDERNAME.get(objUnderTest)  + ", " + DESCRIPTION.get(objUnderTest)  + ", " + STATUS.get(objUnderTest)  + ", " + VERSIONID.get(objUnderTest)  + ", " + OBJECTID.get(objUnderTest)  + ", " + OBJECTNAME.get(objUnderTest)  + ", " + OBJECTVERSION.get(objUnderTest)  + ", " + OBJECTTYPE.get(objUnderTest)  + ", " + JOINABLE.get(objUnderTest)  + ", " + SIZING.get(objUnderTest)  + ", " + TOTALAGG.get(objUnderTest)  + ", " + ELEMENTBHSUPPORT.get(objUnderTest)  + ", " + RANKINGTABLE.get(objUnderTest)  + ", " + DELTACALCSUPPORT.get(objUnderTest)  + ", " + PLAINTABLE.get(objUnderTest)  + ", " + UNIVERSEEXTENSION.get(objUnderTest)  + ", " + VECTORSUPPORT.get(objUnderTest)  + ", " + DATAFORMATSUPPORT.get(objUnderTest)  + ", " + FOLLOWJOHN.get(objUnderTest) ;
    String expected =  "testTYPEID"  + ", testTYPECLASSID"  + ", testTYPENAME"  + ", testVENDORID"  + ", testFOLDERNAME"  + ", testDESCRIPTION"  + ", 1"  + ", testVERSIONID"  + ", testOBJECTID"  + ", testOBJECTNAME"  + ", 1"  + ", testOBJECTTYPE"  + ", testJOINABLE"  + ", testSIZING"  + ", 1"  + ", 1"  + ", 1"  + ", 1"  + ", 1"  + ", testUNIVERSEEXTENSION"  + ", 1"  + ", 1"  + ", 1" ;
    assertEquals(expected, actual);
  }
  ...
  public void testToSQLInsert() throws Exception {
    ...
    String expected = "insert into Measurementtype ( TYPEID, TYPECLASSID, TYPENAME, VENDORID, FOLDERNAME, DESCRIPTION, STATUS, VERSIONID, OBJECTID, OBJECTNAME, OBJECTVERSION, OBJECTTYPE, JOINABLE, SIZING, TOTALAGG, ELEMENTBHSUPPORT, RANKINGTABLE, DELTACALCSUPPORT, PLAINTABLE, UNIVERSEEXTENSION, VECTORSUPPORT, DATAFORMATSUPPORT, FOLLOWJOHN ) values "
      + "( 'testTYPEID', 'testTYPECLASSID', 'testTYPENAME', 'testVENDORID', 'testFOLDERNAME', 'testDESCRIPTION', 1, 'testVERSIONID', 'testOBJECTID', 'testOBJECTNAME', 1, 'testOBJECTTYPE', 'testJOINABLE', 'testSIZING', 1, 1, 1, 1, 1, 'testUNIVERSEEXTENSION', 1, 1, 1 );\n";
