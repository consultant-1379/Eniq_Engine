...
public class MeasurementkeyTest {
  ...
  public void setUp() throws Exception {
    ...
    stmt.executeUpdate("INSERT INTO Measurementkey VALUES( 'testTYPEID'  ,'testDATANAME'  ,'testDESCRIPTION'  ,1  ,1  ,1  ,'testDATATYPE'  ,1  ,1  ,1  ,1  ,'testINDEXES'  ,1  ,'testUNIVOBJECT'  ,1  ,'testDATAID' )");
  ...
  public void testToXML_tag() throws Exception {
    ...
    String expected = "<Measurementkey TYPEID=\"'testTYPEID'\" DATANAME=\"'testDATANAME'\" DESCRIPTION=\"'testDESCRIPTION'\" ISELEMENT=\"1\" UNIQUEKEY=\"1\" COLNUMBER=\"1\" DATATYPE=\"'testDATATYPE'\" DATASIZE=\"1\" DATASCALE=\"1\" UNIQUEVALUE=\"1\" NULLABLE=\"1\" INDEXES=\"'testINDEXES'\" INCLUDESQL=\"1\" UNIVOBJECT=\"'testUNIVOBJECT'\" JOINABLE=\"1\" DATAID=\"'testDATAID'\" DiffStatus=\"\" />\n";
  ...
  public void testToSQLInsert() throws Exception {
    ...
    String expected = "insert into Measurementkey ( TYPEID, DATANAME, DESCRIPTION, ISELEMENT, UNIQUEKEY, COLNUMBER, DATATYPE, DATASIZE, DATASCALE, UNIQUEVALUE, NULLABLE, INDEXES, INCLUDESQL, UNIVOBJECT, JOINABLE, DATAID ) values "
      + "( 'testTYPEID', 'testDATANAME', 'testDESCRIPTION', 1, 1, 1, 'testDATATYPE', 1, 1, 1, 1, 'testINDEXES', 1, 'testUNIVOBJECT', 1, 'testDATAID' );\n";
