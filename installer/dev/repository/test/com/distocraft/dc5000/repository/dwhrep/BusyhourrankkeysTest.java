...
public class BusyhourrankkeysTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    stmt.execute("CREATE TABLE Busyhourrankkeys ( VERSIONID VARCHAR(31)  ,BHLEVEL VARCHAR(255) ,BHTYPE VARCHAR(31) ,KEYNAME VARCHAR(31) ,KEYVALUE VARCHAR(31) ,ORDERNBR BIGINT  ,TARGETVERSIONID VARCHAR(31) ,BHOBJECT VARCHAR(31))");
