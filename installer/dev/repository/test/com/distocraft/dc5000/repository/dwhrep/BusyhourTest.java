...
public class BusyhourTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    stmt.execute("CREATE TABLE Busyhour ( VERSIONID VARCHAR(31)  ,BHLEVEL VARCHAR(255) ,BHTYPE VARCHAR(31) ,BHCRITERIA VARCHAR(31) ,WHERECLAUSE VARCHAR(31) ,DESCRIPTION VARCHAR(31) ,TARGETVERSIONID VARCHAR(31) ,BHOBJECT VARCHAR(31) ,BHELEMENT INTEGER  ,ENABLE INTEGER  ,AGGREGATIONTYPE VARCHAR(31) ,OFFSET INTEGER  ,WINDOWSIZE INTEGER  ,LOOKBACK INTEGER  ,P_THRESHOLD INTEGER  ,N_THRESHOLD INTEGER  ,CLAUSE VARCHAR(31) ,PLACEHOLDERTYPE VARCHAR(31) ,GROUPING VARCHAR(31) ,REACTIVATEVIEWS INTEGER )");
