...
public class PartitionplanTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    stmt.execute("CREATE TABLE Partitionplan ( PARTITIONPLAN VARCHAR(31)  ,DEFAULTSTORAGETIME BIGINT  ,DEFAULTPARTITIONSIZE BIGINT  ,MAXSTORAGETIME BIGINT )");
  ...
  public void setUp() throws Exception {
    ...
    stmt.executeUpdate("INSERT INTO Partitionplan VALUES( 'testPARTITIONPLAN'  ,1  ,1  ,1 )");
  ...
  public void testPartitionplanConstructorWithNullValues() throws Exception {
    ...
    String actual =  PARTITIONPLAN.get(objUnderTest)  + ", " + DEFAULTSTORAGETIME.get(objUnderTest)  + ", " + DEFAULTPARTITIONSIZE.get(objUnderTest)  + ", " + MAXSTORAGETIME.get(objUnderTest) ;
  ...
  public void testPartitionplanConstructorWithPrimaryKeyDefined() throws Exception {
    ...
    String actual =  PARTITIONPLAN.get(objUnderTest)  + ", " + DEFAULTSTORAGETIME.get(objUnderTest)  + ", " + DEFAULTPARTITIONSIZE.get(objUnderTest)  + ", " + MAXSTORAGETIME.get(objUnderTest) ;
    String expected =  "testPARTITIONPLAN"  + ", 1"  + ", 1"  + ", 1" ;
    assertEquals(expected, actual);
  }
  ...
  public void testToXML_tag() throws Exception {
    ...
    String expected = "<Partitionplan PARTITIONPLAN=\"'testPARTITIONPLAN'\" DEFAULTSTORAGETIME=\"1\" DEFAULTPARTITIONSIZE=\"1\" MAXSTORAGETIME=\"1\" DiffStatus=\"\" />\n";
  ...
  public void testToSQLInsert() throws Exception {
    ...
    String expected = "insert into Partitionplan ( PARTITIONPLAN, DEFAULTSTORAGETIME, DEFAULTPARTITIONSIZE, MAXSTORAGETIME ) values "
      + "( 'testPARTITIONPLAN', 1, 1, 1 );\n";
  ...
  */
  ...
  public void testGetDefaultstoragetimeColumnSize() throws Exception {
     ...
     assertEquals(9, objUnderTest.getDefaultstoragetimeColumnSize());   
  }
  ...
  */
  ...
  public void testGetDefaultpartitionsizeColumnSize() throws Exception {
     ...
     assertEquals(9, objUnderTest.getDefaultpartitionsizeColumnSize());   
  }
  ...
  */
  ...
  public void testGetMaxstoragetimeColumnSize() throws Exception {
     ...
     assertEquals(9, objUnderTest.getMaxstoragetimeColumnSize());   
  }
