...
/**
 * Test class for Universeobject. Changes to Universeobject table are made via
 * this class.
 */
public class UniverseobjectTest {

  private static Universeobject objUnderTest;
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    newItem = Universeobject.class.getDeclaredField("newItem");
		VERSIONID = Universeobject.class.getDeclaredField("VERSIONID");
		CLASSNAME = Universeobject.class.getDeclaredField("CLASSNAME");
		UNIVERSEEXTENSION = Universeobject.class.getDeclaredField("UNIVERSEEXTENSION");
		OBJECTNAME = Universeobject.class.getDeclaredField("OBJECTNAME");
		DESCRIPTION = Universeobject.class.getDeclaredField("DESCRIPTION");
		OBJECTTYPE = Universeobject.class.getDeclaredField("OBJECTTYPE");
		QUALIFICATION = Universeobject.class.getDeclaredField("QUALIFICATION");
		AGGREGATION = Universeobject.class.getDeclaredField("AGGREGATION");
		OBJSELECT = Universeobject.class.getDeclaredField("OBJSELECT");
		OBJWHERE = Universeobject.class.getDeclaredField("OBJWHERE");
		PROMPTHIERARCHY = Universeobject.class.getDeclaredField("PROMPTHIERARCHY");
		OBJ_BH_REL = Universeobject.class.getDeclaredField("OBJ_BH_REL");
		ELEM_BH_REL = Universeobject.class.getDeclaredField("ELEM_BH_REL");
		INHERITANCE = Universeobject.class.getDeclaredField("INHERITANCE");
		ORDERNRO = Universeobject.class.getDeclaredField("ORDERNRO");
  ...
  public void setUp() throws Exception {
    ...
    stmt.executeUpdate("INSERT INTO Universeobject VALUES( 'testVERSIONID'  ,'testCLASSNAME'  ,'testUNIVERSEEXTENSION'  ,'testOBJECTNAME'  ,'testDESCRIPTION'  ,'testOBJECTTYPE'  ,'testQUALIFICATION'  ,'testAGGREGATION'  ,'testOBJSELECT'  ,'testOBJWHERE'  ,'testPROMPTHIERARCHY'  ,1  ,1  ,1  ,1 )");

    /* Initializing tested object where primary key is defined */
    objUnderTest = new Universeobject(rockFactory ,  "testVERSIONID",  "testCLASSNAME",  "testUNIVERSEEXTENSION",  "testOBJECTNAME");
  }
  ...
  /**
   * Testing Universeobject constructor variable initialization with null values.
   */
  @Test
  public void testUniverseobjectConstructorWithNullValues() throws Exception {

    /* Calling the tested constructor */
    objUnderTest = new Universeobject(rockFactory, true);
  ...
  /**
   * Testing Universeobject constructor variable initialization with values taken
   * from database.
   */
  @Test
  public void testUniverseobjectConstructorWithPrimaryKeyDefined() throws Exception {
   ...
   */
  @Test
  public void testUniverseobjectConstructorWithPrimaryKeyDefinedNullRockfactory() throws Exception {

    /* Checking that null pointer exception is thrown */
    try {
      objUnderTest = new Universeobject(null ,  "testVERSIONID",  "testCLASSNAME",  "testUNIVERSEEXTENSION",  "testOBJECTNAME");
   ...
   */
  @Test
  public void testUniverseobjectConstructorWithPrimaryKeyUndefined() throws Exception {

    /* Creating where object which tells what sort of query is to be done */
    Universeobject whereObject = new Universeobject(rockFactory);

    /* Calling the tested constructor */
    objUnderTest = new Universeobject(rockFactory, whereObject);
   ...
   */
  @Test
  public void testUniverseobjectConstructorWithPrimaryKeyUndefinedNullRockfactory() throws Exception {
    ...
    /* Asserting that variables are initialized */
    try {
      objUnderTest = new Universeobject(null, whereObject);
      fail("Test failed - NullPointerException was expected as rockfactory was initialized as null!");
    } catch (NullPointerException npe) {
      // test passed
    } catch (Exception e) {
  ...
  public void testGetTableName() throws Exception {
    ...
    assertEquals("Universeobject", objUnderTest.getTableName());
  }
  ...
  public void testSaveToDB() throws Exception {
    ...
    String queryResult = "";
    res = stmt.executeQuery("SELECT VERSIONID FROM Universeobject");
    while (res.next()) {
  ...
  public void testToSQLInsert() throws Exception {
    ...
    String expected = "insert into Universeobject ( VERSIONID, CLASSNAME, UNIVERSEEXTENSION, OBJECTNAME, DESCRIPTION, OBJECTTYPE, QUALIFICATION, AGGREGATION, OBJSELECT, OBJWHERE, PROMPTHIERARCHY, OBJ_BH_REL, ELEM_BH_REL, INHERITANCE, ORDERNRO ) values "
  ...
  public void testSetAndGetVersionid() throws Exception {
    ...
    objUnderTest.setVersionid(UniverseobjectTest.testStringGenerator("anotherVERSIONID", 128));
    assertEquals(UniverseobjectTest.testStringGenerator("anotherVERSIONID", 128), VERSIONID.get(objUnderTest));
  }
    /**
   * Testing column data setting and retrieving via get and set methods.
   */
  ...
  public void testSetAndGetClassname() throws Exception {
    ...
    /* Setting column values and asserting correct value is returned */
    objUnderTest.setClassname(UniverseobjectTest.testStringGenerator("anotherCLASSNAME", 128));
    assertEquals(UniverseobjectTest.testStringGenerator("anotherCLASSNAME", 128), CLASSNAME.get(objUnderTest));
  }
    /**
   * Testing column data setting and retrieving via get and set methods.
   */
  ...
  public void testSetAndGetUniverseextension() throws Exception {
    ...
    /* Setting column values and asserting correct value is returned */
    objUnderTest.setUniverseextension(UniverseobjectTest.testStringGenerator("anotherUNIVERSEEXTENSION", 12));
    assertEquals(UniverseobjectTest.testStringGenerator("anotherUNIVERSEEXTENSION", 12), UNIVERSEEXTENSION.get(objUnderTest));
  }
    /**
   * Testing column data setting and retrieving via get and set methods.
   */
  ...
  public void testSetAndGetObjectname() throws Exception {
    ...
    /* Setting column values and asserting correct value is returned */
    objUnderTest.setObjectname(UniverseobjectTest.testStringGenerator("anotherOBJECTNAME", 128));
    assertEquals(UniverseobjectTest.testStringGenerator("anotherOBJECTNAME", 128), OBJECTNAME.get(objUnderTest));
  }
    /**
   * Testing column data setting and retrieving via get and set methods.
   */
  ...
  public void testSetAndGetDescription() throws Exception {
    ...
    /* Setting column values and asserting correct value is returned */
    objUnderTest.setDescription(UniverseobjectTest.testStringGenerator("anotherDESCRIPTION", 32000));
    assertEquals(UniverseobjectTest.testStringGenerator("anotherDESCRIPTION", 32000), DESCRIPTION.get(objUnderTest));
  }
    /**
   * Testing column data setting and retrieving via get and set methods.
   */
  ...
  public void testSetAndGetObjecttype() throws Exception {
    ...
    /* Setting column values and asserting correct value is returned */
    objUnderTest.setObjecttype(UniverseobjectTest.testStringGenerator("anotherOBJECTTYPE", 16));
    assertEquals(UniverseobjectTest.testStringGenerator("anotherOBJECTTYPE", 16), OBJECTTYPE.get(objUnderTest));
  }
    /**
   * Testing column data setting and retrieving via get and set methods.
   */
  ...
  public void testSetAndGetQualification() throws Exception {
    ...
    /* Setting column values and asserting correct value is returned */
    objUnderTest.setQualification(UniverseobjectTest.testStringGenerator("anotherQUALIFICATION", 16));
    assertEquals(UniverseobjectTest.testStringGenerator("anotherQUALIFICATION", 16), QUALIFICATION.get(objUnderTest));
  }
    /**
   * Testing column data setting and retrieving via get and set methods.
   */
  ...
  public void testSetAndGetAggregation() throws Exception {
    ...
    /* Setting column values and asserting correct value is returned */
    objUnderTest.setAggregation(UniverseobjectTest.testStringGenerator("anotherAGGREGATION", 16));
    assertEquals(UniverseobjectTest.testStringGenerator("anotherAGGREGATION", 16), AGGREGATION.get(objUnderTest));
  }
    /**
   * Testing column data setting and retrieving via get and set methods.
   */
  ...
  public void testSetAndGetObjselect() throws Exception {
    ...
    /* Setting column values and asserting correct value is returned */
    objUnderTest.setObjselect(UniverseobjectTest.testStringGenerator("anotherOBJSELECT", 32000));
    assertEquals(UniverseobjectTest.testStringGenerator("anotherOBJSELECT", 32000), OBJSELECT.get(objUnderTest));
  }
    /**
   * Testing column data setting and retrieving via get and set methods.
   */
  ...
  public void testSetAndGetObjwhere() throws Exception {
    ...
    /* Setting column values and asserting correct value is returned */
    objUnderTest.setObjwhere(UniverseobjectTest.testStringGenerator("anotherOBJWHERE", 32000));
    assertEquals(UniverseobjectTest.testStringGenerator("anotherOBJWHERE", 32000), OBJWHERE.get(objUnderTest));
  }
    /**
   * Testing column data setting and retrieving via get and set methods.
   */
  ...
  public void testSetAndGetPrompthierarchy() throws Exception {
    ...
    /* Setting column values and asserting correct value is returned */
    objUnderTest.setPrompthierarchy(UniverseobjectTest.testStringGenerator("anotherPROMPTHIERARCHY", 255));
    assertEquals(UniverseobjectTest.testStringGenerator("anotherPROMPTHIERARCHY", 255), PROMPTHIERARCHY.get(objUnderTest));
  }
    /**
   * Testing column data setting and retrieving via get and set methods.
   */
  ...
  public void testDbEquals() throws Exception {
    ...
    Universeobject compareObj = new Universeobject(rockFactory ,  "testVERSIONID",  "testCLASSNAME",  "testUNIVERSEEXTENSION",  "testOBJECTNAME");
  ...
  /**
   * Testing comparing another Universeobject with our current one. If the two
   * Universeobjects are the same true is returned, otherwise false.
   */
  @Test
  public void testEqualsWithNullColumnUniverseobject() throws Exception {

    /* Creating another Universeobject which will be compared to the tested one */
    Universeobject comparedObj = new Universeobject(rockFactory, true);
   ...
   */
  @Test
  public void testEqualsWithDifferentUniverseobject() throws Exception {

    /* Creating another Universeobject which will be compared to the tested one */
    Universeobject comparedObj = new Universeobject(rockFactory ,  "testVERSIONID",  "testCLASSNAME",  "testUNIVERSEEXTENSION",  "testOBJECTNAME");
   ...
   */
  @Test
  public void testEqualsWithSameUniverseobject() throws Exception {
  ...
  /**
   * Testing comparing another Universeobject with our current one using null value.
   */
  @Test
  public void testEqualsWithNullUniverseobject() throws Exception {

    /* Creating another aggregation which will be compared to the tested one */
    Universeobject comparedObj = null;

    /* Asserting that exception is thrown */
    try {
      objUnderTest.equals(comparedObj);
      fail("Test Failed - Unexpected NullPointerException expected as compared Universeobject was null \n");
    } catch (NullPointerException npe) {
      // Test passed
    } catch (Exception e) {
  ...
  public void testClone() throws Exception {
    ...
    assertEquals(Universeobject.class, actualObject.getClass());
  }
  ...
  public void testExistsDB() throws Exception {
    ...
    Universeobject testAgg = new Universeobject(rockFactory ,  "testVERSIONID",  "testCLASSNAME",  "testUNIVERSEEXTENSION",  "testOBJECTNAME");
    VERSIONID.set(objUnderTest, "changed");
  ...
  */
  ...
  public void testGetOrdernroColumnSize() throws Exception {
     ...
     assertEquals(126, objUnderTest.getOrdernroColumnSize());   
  }
  ...
  */
  ...
  public void testGetOrdernroDecimalDigits() throws Exception {
     ...
     assertEquals(38, objUnderTest.getOrdernroDecimalDigits());     
  }
  ...
  */
  ...
  /**
   * Testing original Universeobject object setting and retrieving.
   */
  @Test
  public void testSetAndGetOriginal() throws Exception {

    objUnderTest = new Universeobject(rockFactory, false);
  ...
  public void testIsUpdated() throws Exception {
    ...
    Universeobject changedOriginal = new Universeobject(rockFactory, false);
