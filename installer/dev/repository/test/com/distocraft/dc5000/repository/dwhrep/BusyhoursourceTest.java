...
public class BusyhoursourceTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    stmt.execute("CREATE TABLE Busyhoursource ( VERSIONID VARCHAR(31)  ,BHLEVEL VARCHAR(255) ,BHTYPE VARCHAR(31) ,TYPENAME VARCHAR(31) ,TARGETVERSIONID VARCHAR(31) ,BHOBJECT VARCHAR(31))");
