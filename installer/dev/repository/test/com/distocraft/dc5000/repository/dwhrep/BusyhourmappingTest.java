...
public class BusyhourmappingTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    stmt.execute("CREATE TABLE Busyhourmapping ( VERSIONID VARCHAR(31)  ,BHLEVEL VARCHAR(255) ,BHTYPE VARCHAR(31) ,TARGETVERSIONID VARCHAR(31) ,BHOBJECT VARCHAR(31) ,TYPEID VARCHAR(31) ,BHTARGETTYPE VARCHAR(31) ,BHTARGETLEVEL VARCHAR(31) ,ENABLE INTEGER )");
