...
/**
 * Test class for Meta_statuses. Changes to Meta_statuses table are made via
 * this class.
 */
public class Meta_statusesTest {

  private static Meta_statuses objUnderTest;
  ...
  private static Field STATUS_DESCRIPTION;
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    newItem = Meta_statuses.class.getDeclaredField("newItem");
		ID = Meta_statuses.class.getDeclaredField("ID");
		STATUS_DESCRIPTION = Meta_statuses.class.getDeclaredField("STATUS_DESCRIPTION");
		LAST_UPDATED = Meta_statuses.class.getDeclaredField("LAST_UPDATED");
		VERSION_NUMBER = Meta_statuses.class.getDeclaredField("VERSION_NUMBER");
		COLLECTION_SET_ID = Meta_statuses.class.getDeclaredField("COLLECTION_SET_ID");
		COLLECTION_ID = Meta_statuses.class.getDeclaredField("COLLECTION_ID");
		TRANSFER_BATCH_ID = Meta_statuses.class.getDeclaredField("TRANSFER_BATCH_ID");
		TRANSFER_ACTION_ID = Meta_statuses.class.getDeclaredField("TRANSFER_ACTION_ID");
		timeStampName = Meta_statuses.class.getDeclaredField("timeStampName");
	newItem.setAccessible(true);
		ID.setAccessible(true);
		STATUS_DESCRIPTION.setAccessible(true);
    ...
    stmt.execute("CREATE TABLE Meta_statuses ( ID BIGINT  ,STATUS_DESCRIPTION VARCHAR(31) ,LAST_UPDATED TIMESTAMP  ,VERSION_NUMBER VARCHAR(31) ,COLLECTION_SET_ID BIGINT  ,COLLECTION_ID BIGINT  ,TRANSFER_BATCH_ID BIGINT  ,TRANSFER_ACTION_ID BIGINT )");
  ...
  public static void tearDownAfterClass() throws Exception {
    ...
    stmt.execute("DROP TABLE Meta_statuses");
    con = null;
    objUnderTest = null;
  }
  ...
  public void setUp() throws Exception {
    ...
    stmt.executeUpdate("INSERT INTO Meta_statuses VALUES( 1  ,'testSTATUS_DESCRIPTION'  ,'2000-01-01 00:00:00.0'  ,'testVERSION_NUMBER'  ,1  ,1  ,1  ,1 )");

    /* Initializing tested object where primary key is defined */
    objUnderTest = new Meta_statuses(rockFactory ,  1L );
  }
  ...
  public void tearDown() throws Exception {
    ...
    stmt.executeUpdate("DELETE FROM Meta_statuses");
    objUnderTest = null;
  }
  
  /**
   * Testing Meta_statuses constructor variable initialization with null values.
   */
  @Test
  public void testMeta_statusesConstructorWithNullValues() throws Exception {

    /* Calling the tested constructor */
    objUnderTest = new Meta_statuses(rockFactory, true);

    /* Asserting that variables are null initialized */
    String actual =  ID.get(objUnderTest)  + ", " + STATUS_DESCRIPTION.get(objUnderTest)  + ", " + LAST_UPDATED.get(objUnderTest)  + ", " + VERSION_NUMBER.get(objUnderTest)  + ", " + COLLECTION_SET_ID.get(objUnderTest)  + ", " + COLLECTION_ID.get(objUnderTest)  + ", " + TRANSFER_BATCH_ID.get(objUnderTest)  + ", " + TRANSFER_ACTION_ID.get(objUnderTest) ;
    String expected =  null  + ", " + null  + ", " + null  + ", " + null  + ", " + null  + ", " + null  + ", " + null  + ", " + null ;
    assertEquals(expected, actual);
  }
  
  /**
   * Testing Meta_statuses constructor variable initialization with values taken
   * from database.
   */
  @Test
  public void testMeta_statusesConstructorWithPrimaryKeyDefined() throws Exception {
    ...
    String actual =  ID.get(objUnderTest)  + ", " + STATUS_DESCRIPTION.get(objUnderTest)  + ", " + LAST_UPDATED.get(objUnderTest)  + ", " + VERSION_NUMBER.get(objUnderTest)  + ", " + COLLECTION_SET_ID.get(objUnderTest)  + ", " + COLLECTION_ID.get(objUnderTest)  + ", " + TRANSFER_BATCH_ID.get(objUnderTest)  + ", " + TRANSFER_ACTION_ID.get(objUnderTest) ;
    String expected =  "1"  + ", testSTATUS_DESCRIPTION"  + ", 2000-01-01 00:00:00.0"  + ", testVERSION_NUMBER"  + ", 1"  + ", 1"  + ", 1"  + ", 1" ;
    assertEquals(expected, actual);
  }
   ...
   */
  @Test
  public void testMeta_statusesConstructorWithPrimaryKeyDefinedNullRockfactory() throws Exception {

    /* Checking that null pointer exception is thrown */
    try {
      objUnderTest = new Meta_statuses(null ,  1L );
   ...
   */
  @Test
  public void testMeta_statusesConstructorWithPrimaryKeyUndefined() throws Exception {

    /* Creating where object which tells what sort of query is to be done */
    Meta_statuses whereObject = new Meta_statuses(rockFactory);

    /* Calling the tested constructor */
    objUnderTest = new Meta_statuses(rockFactory, whereObject);
   ...
   */
  @Test
  public void testMeta_statusesConstructorWithPrimaryKeyUndefinedNullRockfactory() throws Exception {
    ...
    /* Asserting that variables are initialized */
    try {
      objUnderTest = new Meta_statuses(null, whereObject);
      fail("Test failed - NullPointerException was expected as rockfactory was initialized as null!");
    } catch (NullPointerException npe) {
      // test passed
    } catch (Exception e) {
  ...
  public void testGetTableName() throws Exception {
    ...
    assertEquals("Meta_statuses", objUnderTest.getTableName());
  }
  ...
  public void testSaveDB() throws Exception {
    ...
    /* Getting row count */
    int rows = 0;
    ResultSet res = stmt.executeQuery("SELECT COUNT(*) FROM Meta_statuses");
    while (res.next()) {
      rows = res.getInt(1);
    }
   ...
   */
  @Test
  public void testSetAndGetStatus_description() throws Exception {

    /* Data validating on */
    objUnderTest.setValidateData(true);

    /* Setting column values and asserting correct value is returned */
    objUnderTest.setStatus_description(Meta_statusesTest.testStringGenerator("anotherSTATUS_DESCRIPTION", 32000));
    assertEquals(Meta_statusesTest.testStringGenerator("anotherSTATUS_DESCRIPTION", 32000), STATUS_DESCRIPTION.get(objUnderTest));
  }
    /**
   * Testing column data setting and retrieving via get and set methods.
   */
  ...
  public void testSetAndGetVersion_number() throws Exception {
    ...
    /* Setting column values and asserting correct value is returned */
    objUnderTest.setVersion_number(Meta_statusesTest.testStringGenerator("anotherVERSION_NUMBER", 32));
    assertEquals(Meta_statusesTest.testStringGenerator("anotherVERSION_NUMBER", 32), VERSION_NUMBER.get(objUnderTest));
  }
    /**
   * Testing column data setting and retrieving via get and set methods.
   */
  ...
  /**
   * Testing comparing another Meta_statuses with our current one. If the two
   * Meta_statusess are the same true is returned, otherwise false.
   */
  @Test
  public void testEqualsWithNullColumnMeta_statuses() throws Exception {

    /* Creating another Meta_statuses which will be compared to the tested one */
    Meta_statuses comparedObj = new Meta_statuses(rockFactory, true);
   ...
   */
  @Test
  public void testEqualsWithDifferentMeta_statuses() throws Exception {

    /* Creating another Meta_statuses which will be compared to the tested one */
    Meta_statuses comparedObj = new Meta_statuses(rockFactory ,  1L );
   ...
   */
  @Test
  public void testEqualsWithSameMeta_statuses() throws Exception {
  ...
  /**
   * Testing comparing another Meta_statuses with our current one using null value.
   */
  @Test
  public void testEqualsWithNullMeta_statuses() throws Exception {

    /* Creating another aggregation which will be compared to the tested one */
    Meta_statuses comparedObj = null;

    /* Asserting that exception is thrown */
    try {
      objUnderTest.equals(comparedObj);
      fail("Test Failed - Unexpected NullPointerException expected as compared Meta_statuses was null \n");
    } catch (NullPointerException npe) {
      // Test passed
    } catch (Exception e) {
  ...
  public void testClone() throws Exception {
    ...
    assertEquals(Meta_statuses.class, actualObject.getClass());
  }
  ...
  public void testExistsDB() throws Exception {
    ...
    Meta_statuses testAgg = new Meta_statuses(rockFactory ,  1L );
  ...
  */
  ...
  public void testGetIdSQLType() throws Exception {
    ...
    /**
   * Testing columnsize retrieving for Status_description.
   */
  @Test
  public void testGetStatus_descriptionColumnSize() throws Exception {
    
     assertEquals(32000, objUnderTest.getStatus_descriptionColumnSize());   
  }

 /**
  * Testing decimal digits retrieving for Status_description.
  */
  @Test
  public void testGetStatus_descriptionDecimalDigits() throws Exception {
    
     assertEquals(0, objUnderTest.getStatus_descriptionDecimalDigits());     
  }
  ...
  */
  @Test
  public void testGetStatus_descriptionSQLType() throws Exception {
    
    assertEquals(12, objUnderTest.getStatus_descriptionSQLType());    
  }
