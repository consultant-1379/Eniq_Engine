...
public class Meta_parametersFactoryTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    stmt.execute("CREATE TABLE Meta_parameters ( RB_SEGMENT_NAME VARCHAR(31)  ,USE_RB_SEGMENT_FLAG VARCHAR(31) ,DEFAULT_ERROR_MAIL_ADDR VARCHAR(31) ,DEFAULT_FAIL_MAIL_ADDR VARCHAR(31) ,DEFAULT_BUG_ERROR_MAIL_ADDR VARCHAR(31) ,DEFAULT_MAX_ERROR_VALUE BIGINT  ,DEFAULT_MAX_FK_ERROR_VALUE BIGINT  ,DEFAULT_MAX_COL_LIMIT_VALUE BIGINT  ,TEMP_SUM_TABLESPACE VARCHAR(31) ,USE_TEMP_SUM_TABLESPACE_FLAG VARCHAR(31) ,BATCH_COLUMN_NAME VARCHAR(31) ,VERSION_NUMBER VARCHAR(31))");
  ...
  public void setUp() throws Exception {
    ...
    /* Adding example data to table */
	  stmt.executeUpdate("INSERT INTO Meta_parameters VALUES( 'testRB_SEGMENT_NAME3'  ,'testUSE_RB_SEGMENT_FLAG3'  ,'testDEFAULT_ERROR_MAIL_ADDR3'  ,'testDEFAULT_FAIL_MAIL_ADDR3'  ,'testDEFAULT_BUG_ERROR_MAIL_ADDR3'  ,3  ,3  ,3  ,'testTEMP_SUM_TABLESPACE3'  ,'testUSE_TEMP_SUM_TABLESPACE_FLAG3'  ,'testBATCH_COLUMN_NAME3'  ,'testVERSION_NUMBER3' )");
	  stmt.executeUpdate("INSERT INTO Meta_parameters VALUES( 'testRB_SEGMENT_NAME2'  ,'testUSE_RB_SEGMENT_FLAG2'  ,'testDEFAULT_ERROR_MAIL_ADDR2'  ,'testDEFAULT_FAIL_MAIL_ADDR2'  ,'testDEFAULT_BUG_ERROR_MAIL_ADDR2'  ,2  ,2  ,2  ,'testTEMP_SUM_TABLESPACE2'  ,'testUSE_TEMP_SUM_TABLESPACE_FLAG2'  ,'testBATCH_COLUMN_NAME2'  ,'testVERSION_NUMBER2' )");
	  stmt.executeUpdate("INSERT INTO Meta_parameters VALUES( 'testRB_SEGMENT_NAME1'  ,'testUSE_RB_SEGMENT_FLAG1'  ,'testDEFAULT_ERROR_MAIL_ADDR1'  ,'testDEFAULT_FAIL_MAIL_ADDR1'  ,'testDEFAULT_BUG_ERROR_MAIL_ADDR1'  ,1  ,1  ,1  ,'testTEMP_SUM_TABLESPACE1'  ,'testUSE_TEMP_SUM_TABLESPACE_FLAG1'  ,'testBATCH_COLUMN_NAME1'  ,'testVERSION_NUMBER1' )");
