...
public class Meta_transfer_batchesTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    stmt.execute("CREATE TABLE Meta_transfer_batches ( ID BIGINT  ,START_DATE TIMESTAMP  ,END_DATE TIMESTAMP  ,FAIL_FLAG VARCHAR(31) ,STATUS VARCHAR(31) ,VERSION_NUMBER VARCHAR(31) ,COLLECTION_SET_ID BIGINT  ,COLLECTION_ID BIGINT  ,META_COLLECTION_NAME VARCHAR(31) ,META_COLLECTION_SET_NAME VARCHAR(31) ,SETTYPE VARCHAR(31) ,SLOT_ID INTEGER )");
  ...
  public void setUp() throws Exception {
    ...
    stmt.executeUpdate("INSERT INTO Meta_transfer_batches VALUES( 1  ,'2000-01-01 00:00:00.0'  ,'2000-01-01 00:00:00.0'  ,'testFAIL_FLAG'  ,'testSTATUS'  ,'testVERSION_NUMBER'  ,1  ,1  ,'testMETA_COLLECTION_NAME'  ,'testMETA_COLLECTION_SET_NAME'  ,'testSETTYPE'  ,1 )");
  ...
  public void testMeta_transfer_batchesConstructorWithPrimaryKeyDefined() throws Exception {
    ...
    String actual =  ID.get(objUnderTest)  + ", " + START_DATE.get(objUnderTest)  + ", " + END_DATE.get(objUnderTest)  + ", " + FAIL_FLAG.get(objUnderTest)  + ", " + STATUS.get(objUnderTest)  + ", " + VERSION_NUMBER.get(objUnderTest)  + ", " + COLLECTION_SET_ID.get(objUnderTest)  + ", " + COLLECTION_ID.get(objUnderTest)  + ", " + META_COLLECTION_NAME.get(objUnderTest)  + ", " + META_COLLECTION_SET_NAME.get(objUnderTest)  + ", " + SETTYPE.get(objUnderTest)  + ", " + SLOT_ID.get(objUnderTest) ;
    String expected =  "1"  + ", 2000-01-01 00:00:00.0"  + ", 2000-01-01 00:00:00.0"  + ", testFAIL_FLAG"  + ", testSTATUS"  + ", testVERSION_NUMBER"  + ", 1"  + ", 1"  + ", testMETA_COLLECTION_NAME"  + ", testMETA_COLLECTION_SET_NAME"  + ", testSETTYPE"  + ", 1" ;
    assertEquals(expected, actual);
  }
  ...
  public void testSetAndGetMeta_collection_name() throws Exception {
    ...
    /* Setting column values and asserting correct value is returned */
    objUnderTest.setMeta_collection_name(Meta_transfer_batchesTest.testStringGenerator("anotherMETA_COLLECTION_NAME", 12));
    assertEquals(Meta_transfer_batchesTest.testStringGenerator("anotherMETA_COLLECTION_NAME", 12), META_COLLECTION_NAME.get(objUnderTest));
  }
    /**
   * Testing column data setting and retrieving via get and set methods.
   */
  ...
  public void testSetAndGetMeta_collection_set_name() throws Exception {
    ...
    /* Setting column values and asserting correct value is returned */
    objUnderTest.setMeta_collection_set_name(Meta_transfer_batchesTest.testStringGenerator("anotherMETA_COLLECTION_SET_NAME", 12));
    assertEquals(Meta_transfer_batchesTest.testStringGenerator("anotherMETA_COLLECTION_SET_NAME", 12), META_COLLECTION_SET_NAME.get(objUnderTest));
  }
    /**
   * Testing column data setting and retrieving via get and set methods.
   */
  ...
  */
  ...
  public void testGetMeta_collection_nameColumnSize() throws Exception {
     ...
     assertEquals(12, objUnderTest.getMeta_collection_nameColumnSize());   
  }
  ...
  */
  ...
  public void testGetMeta_collection_set_nameColumnSize() throws Exception {
     ...
     assertEquals(12, objUnderTest.getMeta_collection_set_nameColumnSize());   
  }
  ...
  */
  ...
  public void testGetSettypeColumnSize() throws Exception {
     ...
     assertEquals(12, objUnderTest.getSettypeColumnSize());   
  }
