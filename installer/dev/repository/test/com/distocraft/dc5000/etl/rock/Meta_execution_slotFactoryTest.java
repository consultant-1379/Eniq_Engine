...
public class Meta_execution_slotFactoryTest {
  ...
  public void setUp() throws Exception {
    ...
    /* Adding example data to table */
	  stmt.executeUpdate("INSERT INTO Meta_execution_slot VALUES( 'testPROFILE_ID3'  ,'testSLOT_NAME3'  ,'testSLOT_ID3'  ,'testACCEPTED_SET_TYPES3' )");
	  stmt.executeUpdate("INSERT INTO Meta_execution_slot VALUES( 'testPROFILE_ID2'  ,'testSLOT_NAME2'  ,'testSLOT_ID2'  ,'testACCEPTED_SET_TYPES2' )");
	  stmt.executeUpdate("INSERT INTO Meta_execution_slot VALUES( 'testPROFILE_ID1'  ,'testSLOT_NAME1'  ,'testSLOT_ID1'  ,'testACCEPTED_SET_TYPES1' )");
