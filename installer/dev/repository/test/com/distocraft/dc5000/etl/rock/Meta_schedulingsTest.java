...
public class Meta_schedulingsTest {
   ...
   */
  @Test
  public void testSetAndGetLast_execution_time_forDefaultHour() throws Exception {

    /* Data validating on */
    objUnderTest.setValidateData(true);

    /* Setting column values and asserting correct value is returned */
    objUnderTest.setLast_execution_time(new Timestamp(0));
    Timestamp ts = (Timestamp)LAST_EXECUTION_TIME.get(objUnderTest);
    System.out.println("Time = "+ts.toString());
    assertEquals(new Timestamp(0), LAST_EXECUTION_TIME.get(objUnderTest));
  }
