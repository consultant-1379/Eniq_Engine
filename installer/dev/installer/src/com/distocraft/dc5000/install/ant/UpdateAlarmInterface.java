 ...
 * @author ejannbe
 */
public class UpdateAlarmInterface extends Task {
  ...
  public void execute() throws BuildException {
    ...
    boolean updateSuccessful = this.updateInterface();
  ...
  private boolean updateInterface() {
    try {
      ...
      if (alarmInterfaceVector.size() <= 0) {
        ...
        Alarminterface targetAlarmIntf = (Alarminterface) alarmInterfaceVector.get(0);
