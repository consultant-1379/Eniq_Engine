...
public class UpdateProperties extends Task {
  ...
  public void execute() throws BuildException {
    ...
    if (propertiesFile == null || action == null)
      throw new BuildException("Both inputFile and action must be defined");
    ...
    try {
      ...
      if (key == null || key.equalsIgnoreCase("")) {
        throw new BuildException("When action is " + action + " parameter key must be defined.");
      }
      ...
      if (action.equalsIgnoreCase("add")) {
        ...
        if (props.containsKey(key)) {
          System.out.println("Properties file " + propertiesFile + " already contain value with key " + key
        ...
        if (props.containsKey(key)) {
          ...
          System.out.println("Properties file " + propertiesFile + " does not contain key " + key);
        }
        ...
        if (targetKey == null || targetKey.equalsIgnoreCase("")) {
          throw new BuildException("When action is " + action + " parameter targetKey must be defined.");
        }
        ...
        if (props.containsKey(key) == true) {
          ...
          if(props.containsKey(targetKey) == true ) {
            ...
            if(forceCopy != null && forceCopy.equalsIgnoreCase("TRUE")) {
              System.out.println("Properties file " + propertiesFile + " already contains value for key " + targetKey + ". Will overwrite the existing value.");
              ...
              System.out.println("Properties file " + propertiesFile + " already contains value for key " + targetKey + ". Copying will not be done.");
            }
